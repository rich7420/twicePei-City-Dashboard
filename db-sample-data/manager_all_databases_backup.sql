...
1	user	salami@gmail.com	283aea2d8f9d63c02e165b7869cd7ebe2262d15ef31ea81714a39ab54ee1a42f	\N	\N	\N	\N	\N	t	t	t	f	\N	2025-05-29 13:00:09.883753+00	2025-05-31 15:02:29.392963+00
\.
...
gender_friendly	{#59b3f8,#94eef0,#adbff5,#c9a7fb,#d48dfc}	{ColumnChart}	\N
tec_friendly	{#59b3f8,#94eef0,#adbff5}	{DonutChart}	%
business_count	{#59b3f8,#94eef0,#adbff5,#c9a7fb}	{DonutChart}	%
...
friendly_ratio	{#59b3f8,#94eef0,#adbff5,#c9a7fb,#d48dfc}	{RadarChart,HeatmapChart,BarPercentChart}	個
\.
...
friendly_info	\N	{8}	\N	static	\N	\N	\N	產業局商業處	\N	\N	\N	{https://data.taipei/dataset/detail?id=d807396c-e41f-4005-be42-0160280783a1}	{doit}	2025-05-30 15:09:39.332024+00	2025-05-30 15:09:39.332024+00	two_d	SELECT 行政區 AS x_axis, COUNT(*) AS data FROM public.friendly_info_tpe GROUP BY 行政區 	\N	taipei
friendly_info	\N	{9}	\N	static	\N	\N	\N	\N	\N	\N	\N	{https://data.taipei/dataset/detail?id=d807396c-e41f-4005-be42-0160280783a1,連結2}	{doit,ntpc}	2025-05-30 18:14:37.576979+00	2025-05-30 18:14:37.576979+00	two_d	SELECT 行政區 AS x_axis, COUNT(*) AS data FROM (SELECT 行政區 FROM public.friendly_info_tpe UNION ALL SELECT 行政區 FROM public.friendly_info_new_tpe) AS all_store GROUP BY 行政區	\N	metrotaipei
...
toilet_info	\N	{3}	\N	static	\N	\N	\N	主計處	\N	\N	\N	{}	{doit}	2025-05-31 02:34:27.58766+00	2025-05-31 02:34:27.58766+00	three_d	\nSELECT \n    行政區 AS x_axis,\n    廁所類型 AS y_axis,\n    COUNT(*) AS data\nFROM \n    public.toilet_tpe\nGROUP BY \n    x_axis, y_axis\nORDER BY ARRAY_POSITION(ARRAY['北投區', '士林區', '內湖區', '南港區', '松山區', '信義區', '中山區', '大同區'], 行政區)\n	\N	taipei
tourists_count	null	\N	null	static	\N	\N	\N	主計處	簡短描述	詳細描述	使用案例	{https://data.taipei/dataset/detail?id=1ddeff62-8872-441c-aaf2-10fd0515ddb1}	{doit}	2025-05-31 08:28:52.494561+00	2025-05-31 12:32:08.477581+00	two_d	SELECT 商圈名稱 AS x_axis, ROUND("113年"/1000, 1) AS data FROM public.tourists_tpe WHERE "113年" IS NOT NULL\nORDER BY "113年" DESC\n	\N	taipei
tourists_count	null	\N	null	static	\N	\N	\N	主計處	簡短描述	詳細描述	使用案例	{https://data.taipei/dataset/detail?id=1ddeff62-8872-441c-aaf2-10fd0515ddb1,https://data.ntpc.gov.tw/datasets/1498e0b9-78cc-41c4-b569-e0c7b4458178}	{doit,ntpc}	2025-05-31 08:29:49.623104+00	2025-05-31 09:11:28.583603+00	two_d	SELECT 商圈名稱 AS x_axis, ROUND("113年"/1000, 1) AS data FROM (SELECT 商圈名稱, "113年" FROM tourists_tpe UNION ALL  \n    SELECT 商圈名稱, "113年" FROM tourists_new_tpe) AS combined_data WHERE "113年" IS NOT NULL ORDER BY data DESC\n	\N	metrotaipei
...
aed_taipei_trends	\N	{1}	\N	static	\N	\N	\N	Google Trends	\N	\N	\N	{}	{doit}	2025-05-31 13:40:36.743918+00	2025-05-31 13:40:36.743918+00	bar	SELECT 商圈 AS x_axis, '搜尋熱度' AS y_axis, 搜尋熱度 AS data FROM (SELECT * FROM top5_taipei_trends) d ORDER BY 搜尋熱度 DESC	\N	taipei
taipei_search_trends	\N	{1}	\N	static	\N	\N	\N	Google Trends	\N	\N	\N	{}	{doit}	2025-05-31 13:43:08.215569+00	2025-05-31 13:43:08.215569+00	three_d	SELECT x_axis, data FROM (SELECT '台北車站' AS x_axis, 84.56603773584905 AS data UNION ALL SELECT '大安路' AS x_axis, 82.79245283018868 AS data UNION ALL SELECT '永康街' AS x_axis, 82.16981132075472 AS data UNION ALL SELECT '東區' AS x_axis, 80.64150943396227 AS data UNION ALL SELECT '西門町' AS x_axis, 71.28301886792453 AS data) d ORDER BY data DESC	\N	taipei
year_trend_market	\N	{}	\N	static	\N	\N	\N	Google Trends	\N	\N	\N	{}	{doit}	2025-05-31 13:55:28.258791+00	2025-05-31 13:55:28.258791+00	two_d	SELECT 商圈 AS x_axis, 搜尋熱度 AS data FROM public.year_trend_tpe	\N	taipei
year_trend_market	null	{}	null	static	\N	\N	\N	Google Trends	\N	\N	\N	{}	{doit}	2025-05-31 14:02:18.723585+00	2025-05-31 14:07:15.163613+00	two_d	SELECT 商圈 AS x_axis, 搜尋熱度 AS data FROM public.year_trend_metro	\N	metrotaipei
friendly_ratio	\N	\N	\N	static	\N	\N	\N	產業局商業處	\N	\N	\N	{https://data.taipei/dataset/detail?id=d807396c-e41f-4005-be42-0160280783a1}	{doit,ntpc}	2025-05-31 15:49:40.96828+00	2025-05-31 15:49:40.96828+00	two_d	\N	\N	metrotaipei
tec_friendly	\N	\N	\N	static	\N	\N	\N	產業局商業處	\N	\N	\N	{https://data.taipei/dataset/detail?id=d807396c-e41f-4005-be42-0160280783a1}	{doit,ntpc}	2025-05-31 15:50:17.679012+00	2025-05-31 15:50:17.679012+00	two_d	\N	\N	metrotaipei
gender_friendly	\N	\N	\N	static	\N	\N	\N	產業局商業處	\N	\N	\N	{https://data.taipei/dataset/detail?id=d807396c-e41f-4005-be42-0160280783a1}	{doit,ntpc}	2025-05-31 15:51:14.837385+00	2025-05-31 15:51:14.837385+00	two_d	\N	\N	metrotaipei
lang_friendly	\N	\N	\N	static	\N	\N	\N	產業局商業處	\N	\N	\N	{https://data.taipei/dataset/detail?id=d807396c-e41f-4005-be42-0160280783a1}	{doit,ntpc}	2025-05-31 15:51:38.490739+00	2025-05-31 15:51:38.490739+00	two_d	\N	\N	metrotaipei
lang_friendly	\N	\N	\N	static	\N	\N	\N	產業局商業處	\N	\N	\N	{https://data.taipei/dataset/detail?id=d807396c-e41f-4005-be42-0160280783a1}	{doit}	2025-05-31 15:48:21.980752+00	2025-05-31 15:48:21.980752+00	two_d	\nSELECT\n    '英文友善' AS x_axis,\n    SUM(英文友善) AS data\nFROM\n    public.friendly_info_tpe\n\nUNION ALL\n\nSELECT\n    '韓文友善' AS x_axis,\n    SUM(韓文友善) AS data\nFROM\n    public.friendly_info_tpe\n\nUNION ALL\n\nSELECT\n    '日文友善' AS x_axis,\n    SUM(日文友善) AS data\nFROM\n    public.friendly_info_tpe\nORDER BY\n    x_axis;\n	\N	taipei
tec_friendly	\N	\N	\N	static	\N	\N	\N	產業局商業處	\N	\N	\N	{https://data.taipei/dataset/detail?id=d807396c-e41f-4005-be42-0160280783a1}	{doit}	2025-05-31 15:47:42.782733+00	2025-05-31 15:47:42.782733+00	two_d	\nSELECT\n    '行動裝置充電' AS x_axis,\n    SUM(行動裝置充電) AS data\nFROM\n    public.friendly_info_tpe\n\nUNION ALL\n\nSELECT\n    '便利支付' AS x_axis,\n    SUM(便利支付) AS data\nFROM\n    public.friendly_info_tpe\n\nUNION ALL\n\nSELECT\n    '免費網路' AS x_axis,\n    SUM(免費網路) AS data\nFROM\n    public.friendly_info_tpe\n\nORDER BY\n    x_axis;\n	\N	taipei
business_count	\N	\N	\N	static	\N	\N	\N	財政部	\N	\N	\N	{https://web02.mof.gov.tw/njswww/WebMain.aspx?sys=100&funid=defjspf2}	{doit}	2025-05-31 16:06:59.306469+00	2025-05-31 16:06:59.306469+00	two_d		\N	taipei
business_count	\N	\N	\N	static	\N	\N	\N	財政部	\N	\N	\N	{https://web02.mof.gov.tw/njswww/WebMain.aspx?sys=100&funid=defjspf2,https://web02.mof.gov.tw/njswww/WebMain.aspx?sys=100&funid=defjspf2}	{doit,ntpc}	2025-05-31 16:06:59.306469+00	2025-05-31 16:06:59.306469+00	two_d		\N	metrotaipei
gender_friendly	\N	\N	\N	static	\N	\N	\N	產業局商業處	\N	\N	\N	{https://data.taipei/dataset/detail?id=d807396c-e41f-4005-be42-0160280783a1}	{doit}	2025-05-31 15:48:09.81836+00	2025-05-31 15:48:09.81836+00	two_d	\n\nSELECT\n    '無障礙友善' AS x_axis,\n    SUM(無障礙友善) AS data\nFROM\n    public.friendly_info_tpe\n\nUNION ALL\n\nSELECT\n    '性別友善' AS x_axis,\n    SUM(性別友善) AS data\nFROM\n    public.friendly_info_tpe\n\nUNION ALL\n\nSELECT\n    '友善廁所' AS x_axis,\n    SUM(友善廁所) AS data\nFROM\n    public.friendly_info_tpe\n\nUNION ALL\n\nSELECT\n    '哺集乳室友善' AS x_axis,\n    SUM(哺集乳友善) AS data\nFROM\n    public.friendly_info_tpe\n\nUNION ALL\n\nSELECT\n    '月經友善' AS x_axis,\n    SUM(月經友善) AS data\nFROM\n    public.friendly_info_tpe\n\t\nORDER BY\n    x_axis;\n	\N	taipei
\.
...
SELECT pg_catalog.setval('public.components_id_seq', 17, true);
...
SELECT pg_catalog.setval('public.dashboards_id_seq', 385, true);
