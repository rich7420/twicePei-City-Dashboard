...
6	electric_charging_station_taipei	電動機車充電站	circle	geojson	\N	\N	\N	\N
\.
...
toilet_info	\N	{1}	\N	static	\N	\N	\N	主計處	\N	\N	\N	{}	{doit}	2025-05-31 02:34:27.58766+00	2025-05-31 02:34:27.58766+00	three_d	\nSELECT \n    行政區 as x_axis,\n    CASE \n        WHEN 友善廁所 = 1 THEN '友善廁所'\n        WHEN 友善廁所 = 0 THEN '一般公廁'\n    END AS y_axis,\n    COUNT(*) AS data\nFROM \n    public.toilet_tpe\nGROUP BY \n    x_axis, y_axis\nORDER BY\n    x_axis, y_axis\n	\N	taipei
...
SELECT pg_catalog.setval('public.component_maps_id_seq', 6, true);
