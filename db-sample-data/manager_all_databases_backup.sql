...
1	user	salami@gmail.com	283aea2d8f9d63c02e165b7869cd7ebe2262d15ef31ea81714a39ab54ee1a42f	\N	\N	\N	\N	\N	t	t	t	f	\N	2025-05-29 13:00:09.883753+00	2025-05-31 17:44:48.876211+00
\.
...
toilet_info	{#59b3f8,#94eef0,#adbff5,#c9a7fb}	{DistrictChart,BarPercentChart}	間
friendly_info	{#a0b8e8,#b7ff98,#4369db}	{DistrictChart,ColumnChart}	家
aed_taipei	{#59b3f8,#94eef0,#adbff5,#c9a7fb}	{DistrictChart,ColumnChart,PolarAreaChart}	臺
electric_charging_station	{#a0b8e8,#b7ff98}	{DistrictChart,ColumnChart}	個
year_trend_market	{#59b3f8,#94eef0,#adbff5,#c9a7fb}	{BarChart,TreemapChart}	 
lang_friendly	{#59b3f8,#94eef0,#adbff5}	{DonutChart}	%
tec_friendly	{#59b3f8,#94eef0,#adbff5}	{DonutChart}	%
gender_friendly	{#59b3f8,#94eef0,#adbff5,#c9a7fb,#d48dfc}	{ColumnChart}	個
friendly_ratio	{#59b3f8,#94eef0,#adbff5,#c9a7fb,#d48dfc}	{HeatmapChart}	個
youbike_availability	{#9DC56E,#356340,#9DC56E}	{GuageChart,BarPercentChart}	輛
shopping_area	{#F65658,#F49F36,#F5C860,#9AC17C,#4CB495,#569C9A,#60819C,#2F8AB1}	{HeatmapChart,DistrictChart}	個
tourists_count	{#59b3f8,#94eef0,#adbff5,#c9a7fb}	{BarChart,DonutChart,TreemapChart}	仟人
cate_business_tpe	{#94eef0,#adbff5,#c9a7fb,#d48dfc}	{DistrictChart,ColumnChart}	個
business_count	{#59b3f8,#94eef0,#adbff5,#c9a7fb}	{DonutChart,BarChart}	%
business_category	{#59b3f8,#94eef0,#adbff5,#c9a7fb}	{DonutChart,BarChart}	%
business_shop_count	{#59b3f8,#94eef0,#adbff5,#c9a7fb,#d48dfc}	{DonutChart,BarChart}	%
business_shop_category	{#59b3f8,#94eef0,#adbff5,#c9a7fb,#d48dfc}	{DonutChart,BarChart}	%
\.
...
4	toilet_metrotaipei	公廁與友善廁所分布	circle	geojson	\N	\N	{ "circle-color": [ "match",["get", "廁所類型"],"友善廁所","#5C9CEB","一般廁所","#C7A1E4","#000000"]}	[{"key":"行政區","name":"行政區"},{"key":"名稱","name":"名稱"},{"key":"地址","name":"地址"},{"key":"廁所類型","name":"廁所類型"}]
3	toilet_taipei	公廁與友善廁所分布	circle	geojson	\N	\N	{ "circle-color": [ "match", ["get", "廁所類型"],"友善廁所","#5C9CEB", "一般廁所", "#C7A1E4","#000000"]}	[{"key":"行政區","name":"行政區"},{"key":"名稱","name":"名稱"},{"key":"地址","name":"地址"},{"key":"廁所類型","name":"廁所類型"}]
8	friendly_info_tpe	友善店家分布	circle	geojson	\N	\N	{"circle-color": ["match",["get", "行政區"],\n    "北投區", "#2894FF",\n    "士林區", "#33A1FF",\n    "內湖區", "#4DAAFF",\n    "南港區", "#66B3FF",\n    "松山區", "#7FBFFF",\n    "信義區", "#99CCFF",\n    "中山區", "#B2D8FF",\n    "大同區", "#CCE5FF",\n    "中正區", "#E5F2FF",\n    "萬華區", "#00EC00",\n    "大安區", "#00D900",\n    "文山區", "#00C600",\n    "新莊區", "#FF5733",\n    "淡水區", "#FFC300",\n    "汐止區", "#DAF7A6",\n    "板橋區", "#FF33FF",\n    "三重區", "#C70039",\n    "樹林區", "#900C3F",\n    "土城區", "#581845",\n    "蘆洲區", "#FF5733",\n    "中和區", "#FFC300",\n    "永和區", "#DAF7A6",\n    "新店區", "#FF33FF",\n    "鶯歌區", "#C70039",\n    "三峽區", "#900C3F",\n    "瑞芳區", "#581845",\n    "五股區", "#FF5733",\n    "泰山區", "#FFC300",\n    "林口區", "#DAF7A6",\n    "深坑區", "#FF33FF",\n    "石碇區", "#C70039",\n    "坪林區", "#900C3F",\n    "三芝區", "#581845",\n    "石門區", "#FF5733",\n    "八里區", "#FFC300",\n    "平溪區", "#DAF7A6",\n    "雙溪區", "#FF33FF",\n    "貢寮區", "#C70039",\n    "金山區", "#900C3F",\n    "萬里區", "#581845",\n    "烏來區", "#FF5733",\n    "#CCCCCC"]\n}\n	[\n  { "key": "友善店家名稱", "name": "場所名稱" },\n  { "key": "行政區", "name": "行政區" },\n  { "key": "地址", "name": "場所地址" },\n  { "key": "電話", "name": "聯絡電話" },\n  { "key": "簡介", "name": "場所簡介" }\n]\n
6	electric_charging_station_taipei	電動汽機車充電站	circle	geojson	[null]	\N	{"circle-color": ["match",["get", "車種"],\n    "機車", "#2894FF",\n    "汽車", "#33A1FF",\n    "#CCCCCC"]\n}\n	[{"key":"地址","name":"地址"},{"key":"行政區","name":"行政區"},{"key":"車種","name":"車種"}]
7	electric_charging_station_metrotaipei	電動汽機車充電站	circle	geojson	[null]	\N	{"circle-color": ["match",["get", "車種"],\n    "機車", "#2894FF",\n    "汽車", "#33A1FF",\n    "#CCCCCC"]\n}\n	[{"key":"地址","name":"地址"},{"key":"行政區","name":"行政區"},{"key":"車種","name":"車種"}]
9	friendly_info_metrotpe	友善店家分布	circle	geojson	\N	\N	{"circle-color": ["match",["get", "行政區"],\n    "北投區", "#2894FF",\n    "士林區", "#33A1FF",\n    "內湖區", "#4DAAFF",\n    "南港區", "#66B3FF",\n    "松山區", "#7FBFFF",\n    "信義區", "#99CCFF",\n    "中山區", "#B2D8FF",\n    "大同區", "#CCE5FF",\n    "中正區", "#E5F2FF",\n    "萬華區", "#00EC00",\n    "大安區", "#00D900",\n    "文山區", "#00C600",\n    "新莊區", "#FF5733",\n    "淡水區", "#FFC300",\n    "汐止區", "#DAF7A6",\n    "板橋區", "#FF33FF",\n    "三重區", "#C70039",\n    "樹林區", "#900C3F",\n    "土城區", "#581845",\n    "蘆洲區", "#FF5733",\n    "中和區", "#FFC300",\n    "永和區", "#DAF7A6",\n    "新店區", "#FF33FF",\n    "鶯歌區", "#C70039",\n    "三峽區", "#900C3F",\n    "瑞芳區", "#581845",\n    "五股區", "#FF5733",\n    "泰山區", "#FFC300",\n    "林口區", "#DAF7A6",\n    "深坑區", "#FF33FF",\n    "石碇區", "#C70039",\n    "坪林區", "#900C3F",\n    "三芝區", "#581845",\n    "石門區", "#FF5733",\n    "八里區", "#FFC300",\n    "平溪區", "#DAF7A6",\n    "雙溪區", "#FF33FF",\n    "貢寮區", "#C70039",\n    "金山區", "#900C3F",\n    "萬里區", "#581845",\n    "烏來區", "#FF5733",\n    "#CCCCCC"]\n}\n	[\n  { "key": "友善店家名稱", "name": "場所名稱" },\n  { "key": "行政區", "name": "行政區" },\n  { "key": "地址", "name": "場所地址" },\n  { "key": "電話", "name": "聯絡電話" },\n  { "key": "簡介", "name": "場所簡介" }\n]\n
\.
...
9	shopping_area	行政區活動與商業資源
7	tourists_count	商圈遊客人數統計
12	year_trend_market	商圈搜尋熱度
4	electric_charging_station	電動汽機車換電站
13	lang_friendly	語言友善
14	gender_friendly	生理友善
16	friendly_ratio	友善設施比例
15	tec_friendly	科技友善
17	business_count	營業額佔比
18	business_category	產業類別營業額佔比
19	business_shop_count	商家數占比
20	business_shop_category	商家數產業類別占比
22	cate_business_tpe	行政區五大產業統計
\.
...
385	my-dashboard-kind	好友善	{3,4,5,212}	star	2025-05-31 15:09:59.548216+00	2025-05-31 15:09:59.548216+00
386	business	商圈活化	{}	star	2025-05-31 16:47:11.913884+00	2025-05-31 16:47:11.913884+00
\.
...
tec_friendly	\N	\N	\N	static	\N	\N	\N	產業局商業處	顯示臺北市公共場所科技友善設施的分布與便利性	 此圖表呈現臺北市公共場所科技友善設施的地理分佈，例如：免費Wi-Fi熱點、充電站（含手機及電動車充電）、智慧導覽系統、自助服務機（如電子票務、資訊查詢機）等。圖中將標示這些設施的具體位置，並可結合覆蓋範圍和服務類型進行分析，評估其對民眾使用數位服務的便利程度。此外，圖表也可包含設施的詳細資訊，如網路速度、充電規格、服務語種或支援的支付方式等。透過這些數據，有助於評估城市或區域在智慧化建設上的進程，提供個人便捷的科技服務，並協助政府機關、企業規劃更完善的數位基礎設施，提升城市競爭力與民眾生活品質。	此圖可用於協助臺北市民眾快速找到附近的科技設施，提升數位生活的便利性。例如，旅客可以利用此圖搜尋最近的免費Wi-Fi熱點或手機充電站；需要特殊服務的民眾可查找支援多國語言的智慧導覽系統。對於政府機關而言，此圖是評估城市數位基礎設施建設的重要依據。政府可根據圖中數據，識別科技設施不足的區域，進而規劃增設或升級現有設施，推動數位普及化。同時，私人企業或商業場所也可參考此圖，了解周邊環境的科技友善設施現況，並考慮在其營業場所提供相關科技服務，以吸引顧客、提升營運效率，並響應智慧城市的發展趨勢。	{https://data.taipei/dataset/detail?id=d807396c-e41f-4005-be42-0160280783a1}	{doit}	2025-05-31 15:47:42.782733+00	2025-05-31 15:47:42.782733+00	two_d	\nSELECT\n    '行動裝置充電' AS x_axis,\n    SUM(行動裝置充電) AS data\nFROM\n    public.friendly_info_tpe\n\nUNION ALL\n\nSELECT\n    '便利支付' AS x_axis,\n    SUM(便利支付) AS data\nFROM\n    public.friendly_info_tpe\n\nUNION ALL\n\nSELECT\n    '免費網路' AS x_axis,\n    SUM(免費網路) AS data\nFROM\n    public.friendly_info_tpe\n\nORDER BY\n    x_axis;\n	\N	taipei
...
electric_charging_station	\N	{6}	\N	static	\N	\N	\N	環保局	顯示臺北市電動汽機車換電站的分布情形與服務量能	此圖呈現臺北市範圍內電動汽機車換電站的地理分布與服務項目狀態，涵蓋多家業者與不同型態的換電站（如速換、快充、複合式服務站等）。使用互動式地圖與分類統計圖表，視覺化展示各行政區換電站的密度、可用站點數量與成長趨勢，並標示重點換電熱區及其支援車型範圍。圖表中亦可區分機車與汽車換電站服務類型，有助於瞭解目前綠色交通基礎建設的覆蓋情形與發展現況。此資訊對推動電動車普及與永續交通政策具有重要參考價值。	可用於評估臺北市電動車基礎建設的布局與效能，透過本圖表分析各區換電站密度、站點成長速率與空白區域，進而輔助政府及企業針對性增設設施。同時可依據車型分類（如機車與汽車）進行資源優化規劃，支援民眾查找最近換電據點，並提供政策單位規劃補助路線或設站優先順序參考。亦有助於企業評估合作點位選址，強化電動車使用體驗並推進臺北朝向淨零運輸目標邁進。	{https://data.taipei/dataset/detail?id=668313d7-bcfc-4c90-b769-e398b08a1b2d}	{doit}	2025-05-30 17:07:39.993762+00	2025-05-30 17:07:39.993762+00	two_d	\nSELECT 行政區 AS x_axis, COUNT(*) AS data\n    FROM public.electric_charging_station_tpe\n    GROUP BY 行政區\n    ORDER BY ARRAY_POSITION(ARRAY['北投區', '士林區', '內湖區', '南港區', '松山區', '信義區', '中山區', '大同區', '中正區', '萬華區', '大安區', '文山區', '新莊區', '淡水區', '汐止區', '板橋區', '三重區', '樹林區', '土城區', '蘆洲區', '中和區', '永和區', '新店區', '鶯歌區', '三峽區', '瑞芳區', '五股區', '泰山區', '林口區', '深坑區', '石碇區', '坪林區', '三芝區', '石門區', '八里區', '平溪區', '雙溪區', '貢寮區', '金山區', '萬里區', '烏來區'], 行政區)\n	\N	taipei
...
lang_friendly	\N	\N	\N	static	\N	\N	\N	產業局商業處	顯示臺北市多語言服務設施的分布與可近性。	此圖展示臺北市公共場所多語言服務設施的地理分佈，例如：多語種標示牌、提供多語言服務的人員（如服務中心、醫療院所）、多語音導覽設備、或具備多語翻譯功能的自助服務機等。圖中將標示這些設施的具體位置，並可結合服務語言種類進行分析，評估其對不同語言背景人士的便利程度。此外，圖表也可包含設施的詳細資訊，如支援的語言清單、服務時間或是否提供手語服務等。透過這些數據，有助於評估城市或區域在建構國際化與包容性環境的進程，提供不同語言使用者便利的服務，並協助政府機關、觀光產業與企業規劃更完善的語言支援策略，提升城市對國際訪客與多元族群的吸引力。	此圖可用於協助臺北市的國際旅客或不同語言背景的居民快速找到所需的多語言服務。例如，初次造訪的遊客可利用此圖搜尋提供英語、日語或其他語種服務的醫療院所或觀光服務中心。對於政府機關而言，此圖是評估城市國際化服務水準的重要依據。政府可根據圖中數據，識別多語言服務不足的區域或服務類型，進而規劃增設或改進現有設施，以提升城市對國際人才和觀光客的吸引力。同時，私人企業（特別是觀光、餐飲、零售業）也可參考此圖，了解目標客群的語言需求，並考慮提供相應的多語言服務，以擴大客戶群並提升服務品質。	{https://data.taipei/dataset/detail?id=d807396c-e41f-4005-be42-0160280783a1}	{doit}	2025-05-31 15:48:21.980752+00	2025-05-31 15:48:21.980752+00	two_d	\nSELECT\n    '英文友善' AS x_axis,\n    SUM(英文友善) AS data\nFROM\n    public.friendly_info_tpe\n\nUNION ALL\n\nSELECT\n    '韓文友善' AS x_axis,\n    SUM(韓文友善) AS data\nFROM\n    public.friendly_info_tpe\n\nUNION ALL\n\nSELECT\n    '日文友善' AS x_axis,\n    SUM(日文友善) AS data\nFROM\n    public.friendly_info_tpe\nORDER BY\n    x_axis;\n	\N	taipei
...
cate_business_tpe	null	{}	null	static	\N	\N	\N	主計處	\N	\N	\N	{}	{doit}	2025-05-31 18:33:40.44442+00	2025-05-31 18:40:49.854489+00	three_d	SELECT x_axis, y_axis, data FROM (\n  SELECT 行政區 AS x_axis, '零售、批發及餐飲業' AS y_axis, 店家數 AS data \n  FROM cate_business_tpe \n  WHERE 種類 = '零售、批發及餐飲業' \n  GROUP BY 行政區, 店家數\n  UNION ALL \n  SELECT 行政區 AS x_axis, '文化、運動、休閒及其他服務業' AS y_axis, 店家數 AS data \n  FROM cate_business_tpe \n  WHERE 種類 = '文化、運動、休閒及其他服務業' \n  GROUP BY 行政區, 店家數\n) d \nORDER BY ARRAY_POSITION(ARRAY['中山區', '大安區', '信義區', '萬華區', '內湖區', '松山區', '大同區', '中正區', '士林區', '北投區', '文山區', '南港區'], x_axis), \n         ARRAY_POSITION(ARRAY['零售、批發及餐飲業', '文化、運動、休閒及其他服務業'], y_axis)	\N	taipei
gender_friendly	\N	\N	\N	static	\N	\N	\N	產業局商業處	顯示雙北市生理友善空間的分布與服務普及情形	此圖呈現雙北市內具備生理友善設施的空間分布情況，特別針對『友善廁所』、『哺集乳友善』、『穆斯林友善』與『月經友善』四項關鍵服務進行分類統計。透過地圖視覺化與比例長條圖，使用者可了解各區域的友善空間密度與友善項目提供情況，並可依據需求篩選顯示特定服務類型。圖表亦可顯示各項目在全市店家中的普及率，有助於掌握目前資源分布的均衡程度，辨識仍需加強的區域與項目。此資訊對於政策制定、場域升級與服務優化具參考價值。	可用於評估雙北市在生理友善環境建置方面的整體進展，藉由此圖表分析各友善項目的空間分布與服務密度，辨識特定行政區內友善資源的豐富度與缺口，進而輔助推動針對性的政策，例如擴增哺集乳室設置、改善性別友善廁所覆蓋率等。透過結合地理資訊與分類統計，本組件有助於打造更具包容性與性別平權的城市環境，實踐社會友善、健康平權與多元文化尊重等核心價值。	{https://data.taipei/dataset/detail?id=d807396c-e41f-4005-be42-0160280783a1}	{doit,ntpc}	2025-05-31 15:51:14.837385+00	2025-05-31 15:51:14.837385+00	three_d	\nSELECT\n    x_axis,\n    y_axis,\n    SUM(data) AS data\nFROM (\n    SELECT\n        '無障礙友善' AS x_axis,\n        '臺北' AS y_axis,\n        SUM(無障礙友善) AS data\n    FROM \n        public.friendly_info_tpe\n    GROUP BY y_axis\n    UNION ALL\n    SELECT\n        '無障礙友善' AS x_axis,\n        '新北' AS y_axis,\n        SUM(無障礙友善) AS data\n    FROM\n        public.friendly_info_new_tpe\n    GROUP BY y_axis\n) combined_data\nGROUP BY x_axis, y_axis\n\nUNION ALL\n\nSELECT\n    x_axis,\n    y_axis,\n    SUM(data) AS data\nFROM (\n    SELECT\n        '性別友善' AS x_axis,\n        '臺北' AS y_axis,\n        SUM(性別友善) AS data\n    FROM \n        public.friendly_info_tpe\n    GROUP BY y_axis\n    UNION ALL\n    SELECT\n        '性別友善' AS x_axis,\n        '新北' AS y_axis,\n        SUM(性別友善) AS data\n    FROM\n        public.friendly_info_new_tpe\n    GROUP BY y_axis\n) combined_data\nGROUP BY x_axis, y_axis\n\nUNION ALL\n\nSELECT\n    x_axis,\n    y_axis,\n    SUM(data) AS data\nFROM (\n    SELECT\n        '哺集乳友善' AS x_axis,\n        '臺北' AS y_axis,\n        SUM(哺集乳友善) AS data\n    FROM \n        public.friendly_info_tpe\n    GROUP BY y_axis\n    UNION ALL\n    SELECT\n        '哺集乳友善' AS x_axis,\n        '新北' AS y_axis,\n        SUM(哺集乳友善) AS data\n    FROM\n        public.friendly_info_new_tpe\n    GROUP BY y_axis\n) combined_data\nGROUP BY x_axis, y_axis\n\nUNION ALL\n\nSELECT\n    x_axis,\n    y_axis,\n    SUM(data) AS data\nFROM (\n    SELECT\n        '友善廁所' AS x_axis,\n        '臺北' AS y_axis,\n        SUM(友善廁所) AS data\n    FROM \n        public.friendly_info_tpe\n    GROUP BY y_axis\n    UNION ALL\n    SELECT\n        '友善廁所' AS x_axis,\n        '新北' AS y_axis,\n        SUM(友善廁所) AS data\n    FROM\n        public.friendly_info_new_tpe\n    GROUP BY y_axis\n) combined_data\nGROUP BY x_axis, y_axis\n\nUNION ALL\n\nSELECT\n    x_axis,\n    y_axis,\n    SUM(data) AS data\nFROM (\n    SELECT\n        '月經友善' AS x_axis,\n        '臺北' AS y_axis,\n        SUM(月經友善) AS data\n    FROM \n        public.friendly_info_tpe\n    GROUP BY y_axis\n    UNION ALL\n    SELECT\n        '月經友善' AS x_axis,\n        '新北' AS y_axis,\n        SUM(月經友善) AS data\n    FROM\n        public.friendly_info_new_tpe\n    GROUP BY y_axis\n) combined_data\nGROUP BY x_axis, y_axis\nORDER BY x_axis, y_axis\n	\N	metrotaipei
...
year_trend_market	\N	{}	\N	static	\N	\N	\N	Google Trends	顯示臺北市各商圈在網路上的搜尋聲量與熱門程度。	此圖表呈現臺北市各主要商圈在網路上的搜尋熱度，透過分析社群媒體、搜尋引擎（如Google Trends）的關鍵字搜尋量、線上評論數、導航地圖的路線規劃頻率等數據，量化各商圈的線上關注度與人氣。圖中可運用熱力圖或顏色深淺標示不同商圈的熱度級別，並可結合時間軸，顯示各商圈在不同時段（例如：假日/平日、特定節慶活動期間）的搜尋熱度變化趨勢。此外，圖表也可進一步分析與特定主題（例如：美食、購物、文化活動）相關的搜尋熱度，以描繪商圈的特色與吸引力。透過這些數據，有助於評估商圈的當前知名度與潛力，提供企業進行行銷策略規劃、選址評估，以及政府機關在商圈活化、觀光推廣上的決策參考。	此圖可用於協助企業評估臺北市商圈的潛在客流量與市場吸引力，作為開店選址或行銷推廣的重要依據。例如，新興品牌可透過此圖找出搜尋熱度高且符合其品牌定位的商圈進行拓點。對於觀光業者或活動策劃者而言，此圖可協助他們掌握當前最受歡迎的商圈，進而規劃旅遊行程或舉辦相關活動，以吸引更多人潮。同時，政府單位也可利用此數據評估商圈的活絡程度，識別需要更多資源投入或行銷推廣的商圈，進而制定商圈振興計畫，提升區域經濟發展。此外，投資者也可將商圈搜尋熱度作為評估不動產投資價值的參考指標之一。	{}	{doit}	2025-05-31 13:55:28.258791+00	2025-05-31 13:55:28.258791+00	two_d	SELECT 商圈 AS x_axis, 搜尋熱度 AS data FROM public.year_trend_tpe	\N	taipei
tourists_count	null	\N	null	static	\N	\N	\N	主計處	顯示雙北市各商圈的遊客人數統計與變化趨勢	本圖顯示雙北市主要商圈的遊客人數統計與時間變化趨勢，資料來源可結合感測器統計、人流分析系統與大型活動期間之觀測紀錄，展示各商圈在不同時段、週期與活動檔期中的人潮變化情況。此外，系統可結合天氣、節慶與重大活動等外部因素，分析其對人流的影響，幫助使用者了解旅遊與消費行為的空間與時間分布。	可用於觀光局與商圈自治會制定人流管理與活動規劃策略，分析人潮集中時間與區域以協助安排交通疏導、治安維護與行銷推廣。亦可供店家與品牌評估進駐據點與營運時段選擇，依據人流高峰調整營業時間或促銷活動。對於市政規劃單位而言，本圖表有助於商圈升級改造計畫、人本交通設計與智慧城市空間規劃，強化觀光與商業空間的整合發展。	{https://data.taipei/dataset/detail?id=1ddeff62-8872-441c-aaf2-10fd0515ddb1,https://data.ntpc.gov.tw/datasets/1498e0b9-78cc-41c4-b569-e0c7b4458178}	{doit,ntpc}	2025-05-31 08:29:49.623104+00	2025-05-31 09:11:28.583603+00	two_d	SELECT 商圈名稱 AS x_axis, ROUND("113年"/1000, 1) AS data FROM (SELECT 商圈名稱, "113年" FROM tourists_tpe UNION ALL  \n    SELECT 商圈名稱, "113年" FROM tourists_new_tpe) AS combined_data WHERE "113年" IS NOT NULL ORDER BY data DESC\n	\N	metrotaipei
...
tourists_count	null	\N	null	static	\N	\N	\N	主計處	顯示臺北市各商圈的遊客人數統計與變化趨勢	本圖顯示臺北市主要商圈的遊客人數統計與時間變化趨勢，資料來源可結合感測器統計、人流分析系統與大型活動期間之觀測紀錄，展示各商圈在不同時段、週期與活動檔期中的人潮變化情況。此外，系統可結合天氣、節慶與重大活動等外部因素，分析其對人流的影響，幫助使用者了解旅遊與消費行為的空間與時間分布。	可用於觀光局與商圈自治會制定人流管理與活動規劃策略，分析人潮集中時間與區域以協助安排交通疏導、治安維護與行銷推廣。亦可供店家與品牌評估進駐據點與營運時段選擇，依據人流高峰調整營業時間或促銷活動。對於市政規劃單位而言，本圖表有助於商圈升級改造計畫、人本交通設計與智慧城市空間規劃，強化觀光與商業空間的整合發展。	{https://data.taipei/dataset/detail?id=1ddeff62-8872-441c-aaf2-10fd0515ddb1}	{doit}	2025-05-31 08:28:52.494561+00	2025-05-31 12:32:08.477581+00	two_d	SELECT 商圈名稱 AS x_axis, ROUND("113年"/1000, 1) AS data FROM public.tourists_tpe WHERE "113年" IS NOT NULL\nORDER BY "113年" DESC\n	\N	taipei
aed_taipei	\N	{2}	\N	static	\N	\N	\N	衛生局	顯示自動體外心臟去顫器（AED）在雙北各行政區的分布情況。	此圖表呈現雙北特定區域內（例如：城市、行政區、公共場所）自動體外心臟去顫器（AED）的地理位置分布。圖中將標示出各個AED的具體位置，並可結合可近性分析，評估其距離主要人潮聚集地（例如：車站、商場、學校、運動場館）的便利程度。此外，圖表也可包含AED的詳細資訊，如設置地點（例如：XX百貨公司1樓服務台旁）、管理單位、聯絡方式，以及是否為24小時開放等。透過這些數據，有助於提升民眾對AED位置的掌握度，在緊急情況下能迅速找到並使用AED，爭取黃金救援時間，降低心臟驟停患者的死亡風險。	此圖可用於協助雙北民眾快速找到附近的AED，特別是在緊急情況下，能即時取得救命設備。民眾可透過此圖了解住家、工作場所、或經常活動的區域內AED的分布情況，並事先熟悉其位置。對於政府機關而言，此圖是評估公共場所AED設置密度與可及性的重要依據。政府可根據圖中數據，識別AED設置不足的區域，進而規劃增設AED，或加強AED設置地點的宣導，提升整體急救能力。同時，企業、學校、社區等單位也可參考此圖，評估其場所內是否需要增設AED，或優化現有AED的設置地點與標示，確保在緊急情況下能被快速找到。	{https://data.taipei/dataset/detail?id=64c8a3a0-3b9a-4f49-a13a-fb1eb2ffa4b1}	{doit,ntpc}	2025-05-31 01:40:39.313416+00	2025-05-31 01:40:39.313416+00	three_d	SELECT x_axis, y_axis, data FROM (SELECT 行政區 AS x_axis, '交通要道' AS y_axis, COUNT(*) AS data FROM (SELECT 行政區, 場所分類 FROM aed_new_taipei UNION ALL SELECT 行政區, 場所分類 FROM aed_taipei) combined WHERE 場所分類 IN ('交通要衝', '長距離交通工具') GROUP BY 行政區 UNION ALL SELECT 行政區 AS x_axis, '公共設施與服務' AS y_axis, COUNT(*) AS data FROM (SELECT 行政區, 場所分類 FROM aed_new_taipei UNION ALL SELECT 行政區, 場所分類 FROM aed_taipei) combined WHERE 場所分類 IN ('公眾服務單位設施', '學校、大型集會場所') GROUP BY 行政區 UNION ALL SELECT 行政區 AS x_axis, '休閒與旅遊場所' AS y_axis, COUNT(*) AS data FROM (SELECT 行政區, 場所分類 FROM aed_new_taipei UNION ALL SELECT 行政區, 場所分類 FROM aed_taipei) combined WHERE 場所分類 IN ('大型公眾浴場或溫泉區', '大型休閒場所', '大型購物場所', '旅宿場所', '觀光旅遊地區') GROUP BY 行政區 UNION ALL SELECT 行政區 AS x_axis, '其他' AS y_axis, COUNT(*) AS data FROM (SELECT 行政區, 場所分類 FROM aed_new_taipei UNION ALL SELECT 行政區, 場所分類 FROM aed_taipei) combined WHERE 場所分類 = '其他' GROUP BY 行政區) d ORDER BY ARRAY_POSITION(ARRAY['北投區', '士林區', '內湖區', '中山區', '松山區', '信義區', '中正區', '大安區', '萬華區', '文山區', '新莊區', '淡水區', '汐止區', '板橋區', '三重區', '樹林區', '土城區', '鶯歌區', '中和區', '永和區', '新店區', '三峽區', '瑞芳區', '五股區', '泰山區', '林口區', '深坑區', '石碇區', '坪林區', '三芝區', '石門區', '八里區', '平溪區', '雙溪區', '貢寮區', '金山區', '萬里區', '烏來區'], x_axis), ARRAY_POSITION(ARRAY['交通要道', '公共設施與服務', '休閒與旅遊場所', '其他'], y_axis)	\N	metrotaipei
business_count	null	\N	null	static	\N	0	\N	財政部	顯示雙北不同分類或項目在總營業額中的比例。	此圖表展示雙北特定範圍內（例如：單一企業、某產業、某區域）不同分類或項目在總營業額中所佔的比例，追蹤各分類營業額佔比的變化趨勢，從而揭示其成長或衰退的狀況。透過這些數據，有助於企業進行經營績效分析、資源配置優化、產品策略調整、市場拓展決策，以及政府或研究機構分析經濟結構與產業發展趨勢。	此圖可用於雙北企業內部進行經營決策與績效管理。例如，企業高層可透過營業額佔比圖，快速了解哪些產品或服務是公司的主要收入來源，哪些客戶群貢獻最多營收，或是哪個區域市場表現最佳。這有助於企業將資源集中在最具潛力的產品或市場上，並識別表現不佳的領域以進行改進。銷售團隊可以利用此圖分析不同產品的銷售比重，進而調整銷售策略。同時，投資者也可藉由分析一家公司或某產業的營業額佔比構成，評估其業務組合的健康度、多元性及潛在風險，作為投資決策的重要參考依據。	{https://web02.mof.gov.tw/njswww/WebMain.aspx?sys=100&funid=defjspf2,https://web02.mof.gov.tw/njswww/WebMain.aspx?sys=100&funid=defjspf2}	{doit,ntpc}	2025-05-31 16:06:59.306469+00	2025-05-31 16:46:17.466492+00	two_d	\nWITH taipei_total_revenue AS (\n    -- 計算臺北市的總營業額\n    SELECT SUM("總計_營業額") AS revenue FROM business_tpe\n),\nnew_taipei_total_revenue AS (\n    -- 計算新北市的總營業額\n    SELECT SUM("總計_營業額") AS revenue FROM business_new_tpe\n),\nnationwide_total_revenue AS (\n    -- 計算全臺灣的總銷售額 (假設兩個表的全台銷售額數據一致且完整，取其中一個即可)\n    SELECT SUM("總計_全台銷售額") AS revenue FROM business_tpe -- 或 business_new_tpe\n),\naggregated_revenues AS (\n    -- 彙總各區營業額和全臺灣總銷售額\n    SELECT\n        (SELECT revenue FROM taipei_total_revenue) AS tpe_revenue,\n        (SELECT revenue FROM new_taipei_total_revenue) AS ntpc_revenue,\n        (SELECT revenue FROM nationwide_total_revenue) AS total_nationwide_revenue\n)\n-- 選出臺北市總營業額的百分比\nSELECT\n    '臺北市總營業額' AS x_axis,\n    CASE\n        WHEN total_nationwide_revenue = 0 THEN 0\n        ELSE ROUND((tpe_revenue::NUMERIC * 100.0 / total_nationwide_revenue::NUMERIC), 2)\n    END AS data\nFROM\n    aggregated_revenues\nUNION ALL\n-- 選出新北市總營業額的百分比\nSELECT\n    '新北市總營業額' AS x_axis,\n    CASE\n        WHEN total_nationwide_revenue = 0 THEN 0\n        ELSE ROUND((ntpc_revenue::NUMERIC * 100.0 / total_nationwide_revenue::NUMERIC), 2)\n    END AS data\nFROM\n    aggregated_revenues\nUNION ALL\n-- 計算並選出臺灣其他地區總營業額的百分比\nSELECT\n    '臺灣其他地區總營業額' AS x_axis,\n    CASE\n        WHEN total_nationwide_revenue = 0 THEN 0\n        ELSE ROUND(((total_nationwide_revenue - tpe_revenue - ntpc_revenue)::NUMERIC * 100.0 / total_nationwide_revenue::NUMERIC), 2)\n    END AS data\nFROM\n    aggregated_revenues\n	\N	metrotaipei
youbike_availability	null	{99}	null	current	\N	10	minute	交通局	顯示當前雙北共享單車YouBike的使用情況。	顯示雙北地區（臺北市與新北市）當前共享單車 YouBike 的使用情況，格式為可借車輛數／全區車位數。資料來源為兩市交通局公開資料，每5分鐘更新一次，提供即時的車輛可用資訊與站點使用狀況，有助於掌握整體運行效率與民眾使用情形，亦可作為交通管理與營運調度的參考依據。	藉由顯示雙北地區 YouBike 的使用情況，以及觀察可借車輛數約為車柱總數的一半，可大致掌握目前停放於站點與使用中車輛的整體分布情形。使用者亦可透過地圖模式查詢雙北各站點的即時資訊，包括可借車輛數、可還空位數及站點位置，方便規劃路線與掌握使用狀況，提升共享單車的便利性與使用效率。	{https://tdx.transportdata.tw/api-service/swagger/basic/2cc9b888-a592-496f-99de-9ab35b7fb70d#/Bike/BikeApi_Availability_2181,https://tdx.transportdata.tw/api/basic/v2/Bike/Availability/City/NewTaipei?%24top=30&%24format=JSON}	{doit,ntpc}	2023-12-20 05:56:00+00	2025-05-31 09:13:55.004688+00	percent	\nSELECT x_axis, y_axis, SUM(data) AS data\nFROM (\n    SELECT '在站車輛' AS x_axis,\n           UNNEST(ARRAY['可借車輛', '空位']) AS y_axis,\n           UNNEST(ARRAY[\n             SUM(available_rent_general_bikes),\n             SUM(available_return_bikes)\n           ]) AS data\n    FROM tran_ubike_realtime_new_tpe\n    UNION ALL\n    SELECT '在站車輛' AS x_axis,\n           UNNEST(ARRAY['可借車輛', '空位']) AS y_axis,\n           UNNEST(ARRAY[\n             SUM(available_rent_general_bikes),\n             SUM(available_return_bikes)\n           ]) AS data\n    FROM tran_ubike_realtime\n) AS d\nGROUP BY x_axis, y_axis\n	\N	metrotaipei
friendly_ratio	\N	\N	\N	static	\N	\N	\N	產業局商業處	顯示雙北各行政區各類友善設施佔比。	此圖表呈現雙北特定區域內（例如：行政區、商業區、公共空間）不同類別友善設施在總設施數量中的比例。友善設施的定義可根據分析目的而異，包含提供給身心障礙人士、家庭親子、高齡者、不同語言背景人士、有生理需求者以及需要科技輔助人士的各類便利與支持性設施。圖中通常以圓餅圖或堆疊長條圖呈現各類友善設施的百分比，直觀地顯示其分佈概況。圖表可進一步結合地圖顯示其地理分佈，或結合時間軸追蹤其增長趨勢。透過這些數據，有助於評估城市或區域在建構多元包容與便利環境上的努力與成效，提供政府機關進行政策規劃、資源配置，以及企業與組織提升服務品質與社會責任的參考依據。	此圖可用於協助雙北政府機關評估城市友善化建設的進程與不足之處。例如，市政單位可透過此圖分析各行政區在不同類別友善設施的普及率，進而規劃增設或改善措施，以滿足不同群體的需求。對於企業或場域經營者而言，此圖有助於他們了解其所在區域或自身場域在各類友善設施上的分佈狀況，進而考慮增設或改進相關設施，以吸引更多元客群並提升顧客滿意度。同時，社會團體或研究機構也可利用此圖進行城市宜居性評估，倡議政策改善，促進社會公平與包容。民眾則可參考此圖，選擇前往具備所需友善設施的場所。	{https://data.taipei/dataset/detail?id=d807396c-e41f-4005-be42-0160280783a1}	{doit,ntpc}	2025-05-31 15:49:40.96828+00	2025-05-31 15:49:40.96828+00	three_d	\n\nSELECT\n    x_axis,\n    y_axis,\n    SUM(data) AS data\nFROM (\n    SELECT\n        '無障礙友善' AS x_axis,\n        '臺北' AS y_axis,\n        SUM(無障礙友善) AS data\n    FROM \n        public.friendly_info_tpe\n    GROUP BY y_axis\n    UNION ALL\n    SELECT\n        '無障礙友善' AS x_axis,\n        '新北' AS y_axis,\n        SUM(無障礙友善) AS data\n    FROM\n        public.friendly_info_new_tpe\n    GROUP BY y_axis\n) combined_data\nGROUP BY x_axis, y_axis\n\nUNION ALL\n\nSELECT\n    x_axis,\n    y_axis,\n    SUM(data) AS data\nFROM (\n    SELECT\n        '性別友善' AS x_axis,\n        '臺北' AS y_axis,\n        SUM(性別友善) AS data\n    FROM \n        public.friendly_info_tpe\n    GROUP BY y_axis\n    UNION ALL\n    SELECT\n        '性別友善' AS x_axis,\n        '新北' AS y_axis,\n        SUM(性別友善) AS data\n    FROM\n        public.friendly_info_new_tpe\n    GROUP BY y_axis\n) combined_data\nGROUP BY x_axis, y_axis\n\nUNION ALL\n\nSELECT\n    x_axis,\n    y_axis,\n    SUM(data) AS data\nFROM (\n    SELECT\n        '哺集乳友善' AS x_axis,\n        '臺北' AS y_axis,\n        SUM(哺集乳友善) AS data\n    FROM \n        public.friendly_info_tpe\n    GROUP BY y_axis\n    UNION ALL\n    SELECT\n        '哺集乳友善' AS x_axis,\n        '新北' AS y_axis,\n        SUM(哺集乳友善) AS data\n    FROM\n        public.friendly_info_new_tpe\n    GROUP BY y_axis\n) combined_data\nGROUP BY x_axis, y_axis\n\nUNION ALL\n\nSELECT\n    x_axis,\n    y_axis,\n    SUM(data) AS data\nFROM (\n    SELECT\n        '友善廁所' AS x_axis,\n        '臺北' AS y_axis,\n        SUM(友善廁所) AS data\n    FROM \n        public.friendly_info_tpe\n    GROUP BY y_axis\n    UNION ALL\n    SELECT\n        '友善廁所' AS x_axis,\n        '新北' AS y_axis,\n        SUM(友善廁所) AS data\n    FROM\n        public.friendly_info_new_tpe\n    GROUP BY y_axis\n) combined_data\nGROUP BY x_axis, y_axis\n\nUNION ALL\n\nSELECT\n    x_axis,\n    y_axis,\n    SUM(data) AS data\nFROM (\n    SELECT\n        '月經友善' AS x_axis,\n        '臺北' AS y_axis,\n        SUM(月經友善) AS data\n    FROM \n        public.friendly_info_tpe\n    GROUP BY y_axis\n    UNION ALL\n    SELECT\n        '月經友善' AS x_axis,\n        '新北' AS y_axis,\n        SUM(月經友善) AS data\n    FROM\n        public.friendly_info_new_tpe\n    GROUP BY y_axis\n) combined_data\nGROUP BY x_axis, y_axis\n\nUNION ALL\n\nSELECT\n    x_axis,\n    y_axis,\n    SUM(data) AS data\nFROM (\n    SELECT\n        '穆斯林友善' AS x_axis,\n        '臺北' AS y_axis,\n        SUM(穆斯林友善) AS data\n    FROM \n        public.friendly_info_tpe\n    GROUP BY y_axis\n    UNION ALL\n    SELECT\n        '穆斯林友善' AS x_axis,\n        '新北' AS y_axis,\n        SUM(穆斯林友善) AS data\n    FROM\n        public.friendly_info_new_tpe\n    GROUP BY y_axis\n) combined_data\nGROUP BY x_axis, y_axis\n\nUNION ALL\n\nSELECT\n    x_axis,\n    y_axis,\n    SUM(data) AS data\nFROM (\n    SELECT\n        '自行車友善' AS x_axis,\n        '臺北' AS y_axis,\n        SUM(自行車友善) AS data\n    FROM \n        public.friendly_info_tpe\n    GROUP BY y_axis\n    UNION ALL\n    SELECT\n        '自行車友善' AS x_axis,\n        '新北' AS y_axis,\n        SUM(自行車友善) AS data\n    FROM\n        public.friendly_info_new_tpe\n    GROUP BY y_axis\n) combined_data\nGROUP BY x_axis, y_axis\n\nUNION ALL\n\nSELECT\n    x_axis,\n    y_axis,\n    SUM(data) AS data\nFROM (\n    SELECT\n        '英文友善' AS x_axis,\n        '臺北' AS y_axis,\n        SUM(英文友善) AS data\n    FROM \n        public.friendly_info_tpe\n    GROUP BY y_axis\n    UNION ALL\n    SELECT\n        '英文友善' AS x_axis,\n        '新北' AS y_axis,\n        SUM(英文友善) AS data\n    FROM\n        public.friendly_info_new_tpe\n    GROUP BY y_axis\n) combined_data\nGROUP BY x_axis, y_axis\n\nUNION ALL\n\nSELECT\n    x_axis,\n    y_axis,\n    SUM(data) AS data\nFROM (\n    SELECT\n        '日文友善' AS x_axis,\n        '臺北' AS y_axis,\n        SUM(日文友善) AS data\n    FROM \n        public.friendly_info_tpe\n    GROUP BY y_axis\n    UNION ALL\n    SELECT\n        '日文友善' AS x_axis,\n        '新北' AS y_axis,\n        SUM(日文友善) AS data\n    FROM\n        public.friendly_info_new_tpe\n    GROUP BY y_axis\n) combined_data\nGROUP BY x_axis, y_axis\n\nUNION ALL\n\nSELECT\n    x_axis,\n    y_axis,\n    SUM(data) AS data\nFROM (\n    SELECT\n        '韓文友善' AS x_axis,\n        '臺北' AS y_axis,\n        SUM(韓文友善) AS data\n    FROM \n        public.friendly_info_tpe\n    GROUP BY y_axis\n    UNION ALL\n    SELECT\n        '韓文友善' AS x_axis,\n        '新北' AS y_axis,\n        SUM(韓文友善) AS data\n    FROM\n        public.friendly_info_new_tpe\n    GROUP BY y_axis\n) combined_data\nGROUP BY x_axis, y_axis\n\nUNION ALL\n\nSELECT\n    x_axis,\n    y_axis,\n    SUM(data) AS data\nFROM (\n    SELECT\n        '行動裝置充電' AS x_axis,\n        '臺北' AS y_axis,\n        SUM(行動裝置充電) AS data\n    FROM \n        public.friendly_info_tpe\n    GROUP BY y_axis\n    UNION ALL\n    SELECT\n        '行動裝置充電' AS x_axis,\n        '新北' AS y_axis,\n        SUM(行動裝置充電) AS data\n    FROM\n        public.friendly_info_new_tpe\n    GROUP BY y_axis\n) combined_data\nGROUP BY x_axis, y_axis\n\nUNION ALL\n\nSELECT\n    x_axis,\n    y_axis,\n    SUM(data) AS data\nFROM (\n    SELECT\n        '便利支付' AS x_axis,\n        '臺北' AS y_axis,\n        SUM(便利支付) AS data\n    FROM \n        public.friendly_info_tpe\n    GROUP BY y_axis\n    UNION ALL\n    SELECT\n        '便利支付' AS x_axis,\n        '新北' AS y_axis,\n        SUM(便利支付) AS data\n    FROM\n        public.friendly_info_new_tpe\n    GROUP BY y_axis\n) combined_data\nGROUP BY x_axis, y_axis\n\nUNION ALL\n\nSELECT\n    x_axis,\n    y_axis,\n    SUM(data) AS data\nFROM (\n    SELECT\n        '免費網路' AS x_axis,\n        '臺北' AS y_axis,\n        SUM(免費網路) AS data\n    FROM \n        public.friendly_info_tpe\n    GROUP BY y_axis\n    UNION ALL\n    SELECT\n        '免費網路' AS x_axis,\n        '新北' AS y_axis,\n        SUM(免費網路) AS data\n    FROM\n        public.friendly_info_new_tpe\n    GROUP BY y_axis\n) combined_data\nGROUP BY x_axis, y_axis\n\nORDER BY x_axis, y_axis\n\n	\N	metrotaipei
friendly_info	\N	{9}	\N	static	\N	\N	\N	產業局商業處	顯示雙北市友善店家的統計與分布情形	本圖呈現雙北市已登錄的友善店家數據。圖表分別顯示友善項目總數、各項指標店家數量分布、地理區域（如行政區）密度圖，並分析複合友善特徵的分布比例。此圖有助於掌握整體友善環境的推廣成效，觀察各區友善資源是否均衡，並突顯出特色店家與多元服務指標的地區聚集情形。	可用於社會局、觀光局等單位評估友善政策的推動成效，藉由友善指標統計分析政策涵蓋範圍與資源分布落差。市民與旅客可透過此圖快速查找特定需求店家。本圖也能協助民間企業與店家了解市場趨勢與消費者關注的友善服務項目，進而進行品牌優化與友善服務升級。更進一步，本數據可結合遊客路徑與區域需求進行智慧城市導覽與服務優化應用。	{https://data.taipei/dataset/detail?id=d807396c-e41f-4005-be42-0160280783a1,連結2}	{doit,ntpc}	2025-05-30 18:14:37.576979+00	2025-05-30 18:14:37.576979+00	two_d	SELECT 行政區 AS x_axis, COUNT(*) AS data FROM (SELECT 行政區 FROM public.friendly_info_tpe UNION ALL SELECT 行政區 FROM public.friendly_info_new_tpe) AS all_store GROUP BY 行政區	\N	metrotaipei
friendly_info	\N	{8}	\N	static	\N	\N	\N	產業局商業處	顯示臺北市友善店家的統計與分布情形	本圖呈現臺北市已登錄的友善店家數據。圖表分別顯示友善項目總數、各項指標店家數量分布、地理區域（如行政區）密度圖，並分析複合友善特徵的分布比例。此圖有助於掌握整體友善環境的推廣成效，觀察各區友善資源是否均衡，並突顯出特色店家與多元服務指標的地區聚集情形。	可用於社會局、觀光局等單位評估友善政策的推動成效，藉由友善指標統計分析政策涵蓋範圍與資源分布落差。市民與旅客可透過此圖快速查找特定需求店家。本圖也能協助民間企業與店家了解市場趨勢與消費者關注的友善服務項目，進而進行品牌優化與友善服務升級。更進一步，本數據可結合遊客路徑與區域需求進行智慧城市導覽與服務優化應用。	{https://data.taipei/dataset/detail?id=d807396c-e41f-4005-be42-0160280783a1}	{doit}	2025-05-30 15:09:39.332024+00	2025-05-30 15:09:39.332024+00	two_d	SELECT 行政區 AS x_axis, COUNT(*) AS data FROM public.friendly_info_tpe GROUP BY 行政區 	\N	taipei
business_shop_count	\N	\N	\N	static	\N	\N	\N	財政部	顯示臺北市不同分類或項目在總商家數中的比例	此圖表呈現雙北特定範圍內（例如：單一區域、某產業、某類別）不同分類或項目在總商家數中所佔的比例。透過這些數據，有助於政府機關進行都市發展、商業規劃、政策制定，以及企業進行市場評估、選址決策、競爭分析。	此圖可用於協助政府機關進行城市或區域的商業結構分析。例如，市政單位可透過此圖了解不同區域的商業發展均衡性，或是特定商業區的店家類型分佈，進而規劃相應的輔導政策或基礎設施建設。對於有意投資或拓展業務的企業而言，此圖是評估目標市場商業環境與競爭態勢的重要依據。例如，新品牌可藉由分析不同區域的商家數佔比，找出競爭相對較小或市場需求尚未飽和的潛力區。同時，不動產開發商或仲介也可利用此圖分析各街區的商業活力與潛力，作為商用不動產投資或招租策略的參考。	{https://web02.mof.gov.tw/njswww/WebMain.aspx?sys=100&funid=defjspf2}	{doit}	2025-05-31 17:28:08.539321+00	2025-05-31 17:28:08.539321+00	two_d	\nWITH taipei_total_business_count AS (\n    -- 計算臺北市的總商家數，若無資料則為 0\n    SELECT\n        COALESCE(SUM("總計_商家數"), 0) AS count\n    FROM\n        business_tpe\n),\nnationwide_total_business_count AS (\n    -- 計算全臺灣的總商家數，若無資料則為 0\n    SELECT\n        COALESCE(SUM("總計_全台商家數"), 0) AS count\n    FROM\n        business_tpe \n)\n-- 臺北市總商家數佔全臺灣總商家數的百分比\nSELECT\n    '臺北市總商家數佔比' AS x_axis,\n    CASE\n        WHEN (SELECT count FROM nationwide_total_business_count) = 0 THEN 0\n        ELSE ROUND(((SELECT count FROM taipei_total_business_count)::NUMERIC * 100.0 / (SELECT count FROM nationwide_total_business_count)::NUMERIC), 2)\n    END AS data\nUNION ALL\n-- 臺灣其他地區總商家數佔全臺灣總商家數的百分比\nSELECT\n    '臺灣其他地區商家數佔比' AS x_axis,\n    CASE\n        WHEN (SELECT count FROM nationwide_total_business_count) = 0 THEN 0\n        ELSE ROUND(\n                (GREATEST(0, (SELECT count FROM nationwide_total_business_count) - (SELECT count FROM taipei_total_business_count)))::NUMERIC * 100.0 /\n                (SELECT count FROM nationwide_total_business_count)::NUMERIC\n            , 2)\n    END AS data;\n	\N	taipei
...
shopping_area	\N	{NULL}	\N	static	\N	\N	\N	主計處	顯示行政區的商業活動熱點與人潮聚集區域	此圖展示各行政區的商業活動熱點與人潮聚集區域，透過地圖標示出主要商圈、夜市、觀光景點等人潮密集處。圖表將結合時間軸呈現不同時段（例如：平日/假日、日間/夜間）的人潮流動模式，並分析與周邊交通、大眾運輸站點的關聯性。透過這些數據，可評估各行政區的商業潛力、消費力與活動吸引力，有助於企業進行選址規劃、活動效益評估，並提供政府機關規劃都市發展、交通疏導及公共安全管理等決策參考	圖可用於協助企業評估在不同臺北市行政區設立營業據點的商業潛力。透過地圖呈現的人潮聚集熱點與商業活動分佈，企業可分析各區域的消費族群、人流特性及消費行為模式。同時，政府機關可利用此圖規劃都市發展、交通管理與公共安全策略，例如在人潮密集區增加警力部署或優化大眾運輸路線，提升市民生活品質。此外，活動主辦單位也能依此評估舉辦活動的場地選擇與預期效益，最大化活動的影響力與參與度。	{https://data.taipei/dataset/detail?id=9d7488f5-0f19-45c3-adf9-badf686dda18}	{doit}	2025-05-31 09:10:23.708435+00	2025-05-31 09:10:23.708435+00	three_d	\nWITH all_areas AS (\n    -- 獲取所有行政區的全集\n    SELECT DISTINCT 行政區 AS x_axis FROM public.activities_tpe\n    UNION\n    SELECT DISTINCT 行政區 AS x_axis FROM public.hotel_tpe\n\tUNION\n\tSELECT DISTINCT 行政區 AS x_axis FROM public.tourists_tpe\n\tUNION\n\tSELECT DISTINCT 行政區 AS x_axis FROM public.restaurant_tpe\n),\ncounts AS (\n    -- 計算活動數量\n    SELECT 行政區 AS x_axis, '活動' AS y_axis, COUNT(*) AS data\n    FROM public.activities_tpe\n    GROUP BY 行政區\n    UNION ALL\n    -- 計算旅館數量\n    SELECT 行政區 AS x_axis, '旅館' AS y_axis, COUNT(*) AS data\n    FROM public.hotel_tpe\n    GROUP BY 行政區\n\tUNION ALL\n\t-- 計算商圈數量\n    SELECT 行政區 AS x_axis, '商圈' AS y_axis, COUNT(*) AS data\n    FROM public.tourists_tpe\n    GROUP BY 行政區\n\tUNION ALL\n\t-- 計算餐廳數量\n    SELECT 行政區 AS x_axis, '餐廳' AS y_axis, COUNT(*) AS data\n    FROM public.restaurant_tpe\n    GROUP BY 行政區\n),\nall_combinations AS (\n    -- 建立所有可能的組合（行政區 x 類別）\n    SELECT \n        a.x_axis, \n        y.y_axis\n    FROM \n        all_areas a\n    CROSS JOIN (\n        SELECT '活動' AS y_axis \n        UNION ALL \n        SELECT '旅館'\n\t\tUNION ALL\n\t\tSELECT '商圈'\n\t\tUNION ALL\n\t\tSELECT '餐廳'\n    ) y\n)\nSELECT \n    ac.x_axis,\n    ac.y_axis,\n    COALESCE(c.data, 0) AS data\nFROM \n    all_combinations ac\nLEFT JOIN \n    counts c\nON \n    ac.x_axis = c.x_axis AND ac.y_axis = c.y_axis\nORDER BY \n    ac.x_axis, ac.y_axis;\n	\N	taipei
...
aed_taipei	\N	{1}	\N	static	\N	\N	\N	衛生局	顯示自動體外心臟去顫器（AED）在臺北市各行政區的分布情況。	此圖表呈現臺北市特定區域內（例如：城市、行政區、公共場所）自動體外心臟去顫器（AED）的地理位置分布。圖中將標示出各個AED的具體位置，並可結合可近性分析，評估其距離主要人潮聚集地（例如：車站、商場、學校、運動場館）的便利程度。此外，圖表也可包含AED的詳細資訊，如設置地點（例如：XX百貨公司1樓服務台旁）、管理單位、聯絡方式，以及是否為24小時開放等。透過這些數據，有助於提升民眾對AED位置的掌握度，在緊急情況下能迅速找到並使用AED，爭取黃金救援時間，降低心臟驟停患者的死亡風險。	此圖可用於協助臺北市民眾快速找到附近的AED，特別是在緊急情況下，能即時取得救命設備。民眾可透過此圖了解住家、工作場所、或經常活動的區域內AED的分布情況，並事先熟悉其位置。對於政府機關而言，此圖是評估公共場所AED設置密度與可及性的重要依據。政府可根據圖中數據，識別AED設置不足的區域，進而規劃增設AED，或加強AED設置地點的宣導，提升整體急救能力。同時，企業、學校、社區等單位也可參考此圖，評估其場所內是否需要增設AED，或優化現有AED的設置地點與標示，確保在緊急情況下能被快速找到。	{https://data.taipei/dataset/detail?id=64c8a3a0-3b9a-4f49-a13a-fb1eb2ffa4b1}	{doit}	2025-05-31 01:40:34.741832+00	2025-05-31 01:40:34.741832+00	three_d	SELECT x_axis, y_axis, data FROM (SELECT 行政區 AS x_axis, '交通要道' AS y_axis, COUNT(*) AS data FROM public.aed_taipei WHERE 場所分類 IN ('交通要衝', '長距離交通工具') GROUP BY 行政區 UNION ALL SELECT 行政區 AS x_axis, '公共設施與服務' AS y_axis, COUNT(*) AS data FROM public.aed_taipei WHERE 場所分類 IN ('公眾服務單位設施', '學校、大型集會場所') GROUP BY 行政區 UNION ALL SELECT 行政區 AS x_axis, '休閒與旅遊場所' AS y_axis, COUNT(*) AS data FROM aed_taipei WHERE 場所分類 IN ('大型公眾浴場或溫泉區', '大型休閒場所', '大型購物場所', '旅宿場所', '觀光旅遊地區') GROUP BY 行政區 UNION ALL SELECT 行政區 AS x_axis, '其他' AS y_axis, COUNT(*) AS data FROM public.aed_taipei WHERE 場所分類 = '其他' GROUP BY 行政區) d ORDER BY ARRAY_POSITION(ARRAY['北投區', '士林區', '內湖區', '南港區', '松山區', '信義區', '中山區', '大同區'], x_axis), ARRAY_POSITION(ARRAY['交通要道', '公共設施與服務', '休閒與旅遊場所', '其他'], y_axis)	\N	taipei
toilet_info	\N	{4}	\N	static	\N	\N	\N	環保局	顯示雙北市友善廁所與一般公廁的分布情形與服務覆蓋率	此圖表展示雙北市內公廁設施的空間分布與友善程度，主要區分為『一般公廁』與『友善廁所』（具備無障礙空間、性別友善設計、哺乳室等設施）。透過地圖可視化與分類統計圖，可分析各行政區友善廁所的密度與佔比，同時標示資源集中與不足區域。圖表亦可呈現友善廁所在整體廁所中的占比，協助理解雙北在無障礙與性別友善公共設施方面的建設進展。該資料有助於促進公共空間普及友善設施、提升市民如廁體驗與使用安全。	可用於評估雙北市在推動友善廁所普及政策的成效，透過地圖與統計圖分析各區友善公廁與一般公廁的分布差異。政府單位可根據此資料辨識設施密度不均、資源不足區域，作為後續設站與改善依據；民間開發者亦可整合進行如廁點查詢應用，提升民眾對友善空間的使用率與感受。此分析亦有助於監測性別友善與無障礙空間的城市進展，推動公共設施朝向普及與平權發展。	{https://pse.is/5ytt55}	{doit,ntpc}	2025-05-30 15:08:44.858284+00	2025-05-30 15:08:44.858284+00	three_d	\nSELECT \n    行政區 as x_axis,\n    廁所類型 AS y_axis,\n    COUNT(*) AS data\nFROM (\n    SELECT 行政區, 廁所類型 FROM public.toilet_tpe\n    UNION ALL\n    SELECT 行政區, 廁所類型 FROM public.toilet_new_tpe\n) AS combined_tables\nGROUP BY \n    x_axis, y_axis\nORDER BY ARRAY_POSITION(ARRAY['北投區', '士林區', '內湖區', '中山區', '松山區', '信義區', '中正區', '大安區', '萬華區', '文山區', '新莊區', '淡水區', '汐止區', '板橋區', '三重區', '樹林區', '土城區', '鶯歌區', '中和區', '永和區', '新店區', '三峽區', '瑞芳區', '五股區', '泰山區', '林口區', '深坑區', '石碇區', '坪林區', '三芝區', '石門區', '八里區', '平溪區', '雙溪區', '貢寮區', '金山區', '萬里區', '烏來區'], 行政區)\n	\N	metrotaipei
tec_friendly	\N	\N	\N	static	\N	\N	\N	產業局商業處	顯示雙北公共場所科技友善設施的分布與便利性	 此圖表呈現雙北公共場所科技友善設施的地理分佈，例如：免費Wi-Fi熱點、充電站（含手機及電動車充電）、智慧導覽系統、自助服務機（如電子票務、資訊查詢機）等。圖中將標示這些設施的具體位置，並可結合覆蓋範圍和服務類型進行分析，評估其對民眾使用數位服務的便利程度。此外，圖表也可包含設施的詳細資訊，如網路速度、充電規格、服務語種或支援的支付方式等。透過這些數據，有助於評估城市或區域在智慧化建設上的進程，提供個人便捷的科技服務，並協助政府機關、企業規劃更完善的數位基礎設施，提升城市競爭力與民眾生活品質。	此圖可用於協助雙北民眾快速找到附近的科技設施，提升數位生活的便利性。例如，旅客可以利用此圖搜尋最近的免費Wi-Fi熱點或手機充電站；需要特殊服務的民眾可查找支援多國語言的智慧導覽系統。對於政府機關而言，此圖是評估城市數位基礎設施建設的重要依據。政府可根據圖中數據，識別科技設施不足的區域，進而規劃增設或升級現有設施，推動數位普及化。同時，私人企業或商業場所也可參考此圖，了解周邊環境的科技友善設施現況，並考慮在其營業場所提供相關科技服務，以吸引顧客、提升營運效率，並響應智慧城市的發展趨勢。	{https://data.taipei/dataset/detail?id=d807396c-e41f-4005-be42-0160280783a1}	{doit,ntpc}	2025-05-31 15:50:17.679012+00	2025-05-31 15:50:17.679012+00	two_d	\nSELECT\n    x_axis,\n    SUM(data) AS data\nFROM (\n    SELECT\n        '行動裝置充電' AS x_axis,\n        SUM(行動裝置充電) AS data\n    FROM \n        public.friendly_info_tpe\n    UNION ALL\n    SELECT\n        '行動裝置充電' AS x_axis,\n        SUM(行動裝置充電) AS data\n    FROM\n        public.friendly_info_new_tpe\n) combined_data\nGROUP BY x_axis\n\nUNION ALL\n\nSELECT\n    x_axis,\n    SUM(data) AS data\nFROM (\n    SELECT\n        '便利支付' AS x_axis,\n        SUM(便利支付) AS data\n    FROM \n        public.friendly_info_tpe\n    UNION ALL\n    SELECT\n        '便利支付' AS x_axis,\n        SUM(便利支付) AS data\n    FROM\n        public.friendly_info_new_tpe\n) combined_data\nGROUP BY x_axis\n\nUNION ALL\n\nSELECT\n    x_axis,\n    SUM(data) AS data\nFROM (\n    SELECT\n        '免費網路' AS x_axis,\n        SUM(免費網路) AS data\n    FROM \n        public.friendly_info_tpe\n    UNION ALL\n    SELECT\n        '免費網路' AS x_axis,\n        SUM(免費網路) AS data\n    FROM\n        public.friendly_info_new_tpe\n) combined_data\nGROUP BY x_axis\n\nORDER BY x_axis\n\n	\N	metrotaipei
shopping_area	\N	\N	\N	static	\N	\N	\N	主計處	顯示行政區的商業活動熱點與人潮聚集區域	此圖展示各行政區的商業活動熱點與人潮聚集區域，透過地圖標示出主要商圈、夜市、觀光景點等人潮密集處。圖表將結合時間軸呈現不同時段（例如：平日/假日、日間/夜間）的人潮流動模式，並分析與周邊交通、大眾運輸站點的關聯性。透過這些數據，可評估各行政區的商業潛力、消費力與活動吸引力，有助於企業進行選址規劃、活動效益評估，並提供政府機關規劃都市發展、交通疏導及公共安全管理等決策參考	圖可用於協助企業評估在不同雙北行政區設立營業據點的商業潛力。透過地圖呈現的人潮聚集熱點與商業活動分佈，企業可分析各區域的消費族群、人流特性及消費行為模式。同時，政府機關可利用此圖規劃都市發展、交通管理與公共安全策略，例如在人潮密集區增加警力部署或優化大眾運輸路線，提升市民生活品質。此外，活動主辦單位也能依此評估舉辦活動的場地選擇與預期效益，最大化活動的影響力與參與度。	{https://data.taipei/dataset/detail?id=64c8a3a0-3b9a-4f49-a13a-fb1eb2ffa4b1}	{doit,ntpc}	2025-05-31 10:44:52.967248+00	2025-05-31 10:44:52.967248+00	three_d	\nWITH all_areas AS (\n    -- 獲取所有行政區的全集\n    SELECT DISTINCT 行政區 AS x_axis \n    FROM (\n        SELECT 行政區 FROM public.activities_tpe\n        UNION ALL\n        SELECT 行政區 FROM public.activities_new_tpe\n        UNION\n        SELECT 行政區 FROM public.hotel_tpe\n        UNION ALL\n        SELECT 行政區 FROM public.hotel_new_tpe\n\t\tUNION\n\t\tSELECT 行政區 FROM public.tourists_tpe\n\t\tUNION ALL \n\t\tSELECT 行政區 FROM public.tourists_new_tpe\n\t\tUNION\n\t\tSELECT 行政區 FROM public.restaurant_tpe\n\t\tUNION ALL \n\t\tSELECT 行政區 FROM public.restaurant_new_tpe\n    ) AS all_districts\n),\ncombined_data AS (\n    -- 計算活動和旅館和商圈的數據總數\n    SELECT 行政區 AS x_axis, '活動' AS y_axis, COUNT(*) AS data\n    FROM (\n        SELECT 行政區 FROM public.activities_tpe\n        UNION ALL\n        SELECT 行政區 FROM public.activities_new_tpe\n    ) AS all_activities\n    GROUP BY 行政區\n\n    UNION ALL\n\n    SELECT 行政區 AS x_axis, '旅館' AS y_axis, COUNT(*) AS data\n    FROM (\n        SELECT 行政區 FROM public.hotel_tpe\n        UNION ALL\n        SELECT 行政區 FROM public.hotel_new_tpe\n    ) AS all_hotels\n    GROUP BY 行政區\n\n\tUNION ALL\n\n    SELECT 行政區 AS x_axis, '商圈' AS y_axis, COUNT(*) AS data\n    FROM (\n        SELECT 行政區 FROM public.tourists_tpe\n        UNION ALL\n        SELECT 行政區 FROM public.tourists_new_tpe\n    ) AS all_tourists\n    GROUP BY 行政區\n\n\tUNION ALL\n\n    SELECT 行政區 AS x_axis, '餐廳' AS y_axis, COUNT(*) AS data\n    FROM (\n        SELECT 行政區 FROM public.restaurant_tpe\n        UNION ALL\n        SELECT 行政區 FROM public.restaurant_new_tpe\n    ) AS all_restaurants\n    GROUP BY 行政區\n),\nall_combinations AS (\n    -- 建立行政區與類別的所有組合\n    SELECT \n        a.x_axis, \n        y.y_axis\n    FROM \n        all_areas a\n    CROSS JOIN (\n        SELECT '活動' AS y_axis \n        UNION ALL \n        SELECT '旅館'\n\t\tUNION ALL\n\t\tSELECT '商圈'\n\t\tUNION ALL\n\t\tSELECT '餐廳'\n    ) y\n)\nSELECT \n    ac.x_axis, \n    ac.y_axis, \n    COALESCE(cd.data, 0) AS data\nFROM \n    all_combinations ac\nLEFT JOIN \n    combined_data cd\nON \n    ac.x_axis = cd.x_axis AND ac.y_axis = cd.y_axis\nORDER BY \n    ac.x_axis, ac.y_axis;\n	\N	metrotaipei
cate_business_tpe	null	{}	null	static	\N	0	\N	主計處	\N	\N	\N	{}	{doit,ntpc}	2025-05-31 18:49:16.532639+00	2025-05-31 18:51:04.961139+00	three_d	SELECT x_axis, y_axis, data FROM (\n  -- 台北市數據\n  SELECT 行政區 AS x_axis, '零售、批發及餐飲業' AS y_axis, 店家數 AS data \n  FROM cate_business_tpe \n  WHERE 種類 = '零售、批發及餐飲業' \n  GROUP BY 行政區, 店家數\n  \n  UNION ALL \n  \n  SELECT 行政區 AS x_axis, '文化、運動、休閒及其他服務業' AS y_axis, 店家數 AS data \n  FROM cate_business_tpe \n  WHERE 種類 = '文化、運動、休閒及其他服務業' \n  GROUP BY 行政區, 店家數\n  \n  UNION ALL\n  \n  -- 新北市數據\n  SELECT 行政區 AS x_axis, '零售、批發及餐飲業' AS y_axis, 店家數 AS data \n  FROM cate_business_newtpe \n  WHERE 種類 = '零售、批發及餐飲業' \n  GROUP BY 行政區, 店家數\n  \n  UNION ALL \n  \n  SELECT 行政區 AS x_axis, '文化、運動、休閒及其他服務業' AS y_axis, 店家數 AS data \n  FROM cate_business_newtpe \n  WHERE 種類 = '文化、運動、休閒及其他服務業' \n  GROUP BY 行政區, 店家數\n) d \nORDER BY ARRAY_POSITION(ARRAY['北投區', '士林區', '內湖區', '中山區', '松山區', '信義區', '中正區', '大安區', '萬華區', '文山區', '新莊區', '淡水區', '汐止區', '板橋區', '三重區', '樹林區', '土城區', '鶯歌區', '中和區', '永和區', '新店區', '三峽區', '瑞芳區', '五股區', '泰山區', '林口區', '深坑區', '石碇區', '坪林區', '三芝區', '石門區', '八里區', '平溪區', '雙溪區', '貢寮區', '金山區', '萬里區', '烏來區'], x_axis), \n         ARRAY_POSITION(ARRAY['零售、批發及餐飲業', '文化、運動、休閒及其他服務業'], y_axis)	\N	metrotaipei
friendly_ratio	\N	\N	\N	static	\N	\N	\N	產業局商業處	顯示臺北市各行政區各類友善設施佔比。	此圖表呈現臺北市特定區域內（例如：行政區、商業區、公共空間）不同類別友善設施在總設施數量中的比例。友善設施的定義可根據分析目的而異，包含提供給身心障礙人士、家庭親子、高齡者、不同語言背景人士、有生理需求者以及需要科技輔助人士的各類便利與支持性設施。圖中通常以圓餅圖或堆疊長條圖呈現各類友善設施的百分比，直觀地顯示其分佈概況。圖表可進一步結合地圖顯示其地理分佈，或結合時間軸追蹤其增長趨勢。透過這些數據，有助於評估城市或區域在建構多元包容與便利環境上的努力與成效，提供政府機關進行政策規劃、資源配置，以及企業與組織提升服務品質與社會責任的參考依據。	此圖可用於協助臺北市政府機關評估城市友善化建設的進程與不足之處。例如，市政單位可透過此圖分析各行政區在不同類別友善設施的普及率，進而規劃增設或改善措施，以滿足不同群體的需求。對於企業或場域經營者而言，此圖有助於他們了解其所在區域或自身場域在各類友善設施上的分佈狀況，進而考慮增設或改進相關設施，以吸引更多元客群並提升顧客滿意度。同時，社會團體或研究機構也可利用此圖進行城市宜居性評估，倡議政策改善，促進社會公平與包容。民眾則可參考此圖，選擇前往具備所需友善設施的場所。	{https://data.taipei/dataset/detail?id=64c8a3a0-3b9a-4f49-a13a-fb1eb2ffa4b1}	{doit}	2025-05-31 15:45:54.542375+00	2025-05-31 15:45:54.542375+00	three_d	\nSELECT\n\t行政區 AS x_axis,\n    '穆斯林友善' AS y_axis,\n    SUM(穆斯林友善) AS data\nFROM\n    public.friendly_info_tpe\nGROUP BY 行政區\n\nUNION ALL\n\nSELECT\n\t行政區 AS x_axis,\n    '自行車友善' AS y_axis,\n    SUM(自行車友善) AS data\nFROM\n    public.friendly_info_tpe\nGROUP BY 行政區\n\nUNION ALL\n\nSELECT\n\t行政區 AS x_axis,\n    '無障礙友善' AS y_axis,\n    SUM(無障礙友善) AS data\nFROM\n    public.friendly_info_tpe\nGROUP BY 行政區\n\nUNION ALL\n\nSELECT\n\t行政區 AS x_axis,\n    '性別友善' AS y_axis,\n    SUM(性別友善) AS data\nFROM\n    public.friendly_info_tpe\nGROUP BY 行政區\n\nUNION ALL\n\nSELECT\n\t行政區 AS x_axis,\n    '友善廁所' AS y_axis,\n    SUM(友善廁所) AS data\nFROM\n    public.friendly_info_tpe\nGROUP BY 行政區\n\nUNION ALL\n\nSELECT\n\t行政區 AS x_axis,\n    '哺集乳室友善' AS y_axis,\n    SUM(哺集乳友善) AS data\nFROM\n    public.friendly_info_tpe\nGROUP BY 行政區\n\nUNION ALL\n\nSELECT\n\t行政區 AS x_axis,\n    '月經友善' AS y_axis,\n    SUM(月經友善) AS data\nFROM\n    public.friendly_info_tpe\nGROUP BY 行政區\n\nUNION ALL\n\nSELECT\n\t行政區 AS x_axis,\n    '英文友善' AS y_axis,\n    SUM(英文友善) AS data\nFROM\n    public.friendly_info_tpe\nGROUP BY 行政區\n\nUNION ALL\n\nSELECT\n\t行政區 AS x_axis,\n    '韓文友善' AS y_axis,\n    SUM(韓文友善) AS data\nFROM\n    public.friendly_info_tpe\nGROUP BY 行政區\n\nUNION ALL\n\nSELECT\n\t行政區 AS x_axis,\n    '日文友善' AS y_axis,\n    SUM(日文友善) AS data\nFROM\n    public.friendly_info_tpe\nGROUP BY 行政區\n\nUNION ALL\n\nSELECT\n\t行政區 AS x_axis,\n    '行動裝置充電' AS y_axis,\n    SUM(行動裝置充電) AS data\nFROM\n    public.friendly_info_tpe\nGROUP BY 行政區\n\nUNION ALL\n\nSELECT\n\t行政區 AS x_axis,\n    '便利支付' AS y_axis,\n    SUM(便利支付) AS data\nFROM\n    public.friendly_info_tpe\nGROUP BY 行政區\n\nUNION ALL\n\nSELECT\n\t行政區 AS x_axis,\n    '免費網路' AS y_axis,\n    SUM(免費網路) AS data\nFROM\n    public.friendly_info_tpe\nGROUP BY 行政區\n\nORDER BY\n    x_axis, y_axis;\n	\N	taipei
business_count	\N	\N	\N	static	\N	\N	\N	財政部	顯示臺北市不同分類或項目在總營業額中的比例。	此圖表展示臺北市特定範圍內（例如：單一企業、某產業、某區域）不同分類或項目在總營業額中所佔的比例，追蹤各分類營業額佔比的變化趨勢，從而揭示其成長或衰退的狀況。透過這些數據，有助於企業進行經營績效分析、資源配置優化、產品策略調整、市場拓展決策，以及政府或研究機構分析經濟結構與產業發展趨勢。	此圖可用於臺北市企業內部進行經營決策與績效管理。例如，企業高層可透過營業額佔比圖，快速了解哪些產品或服務是公司的主要收入來源，哪些客戶群貢獻最多營收，或是哪個區域市場表現最佳。這有助於企業將資源集中在最具潛力的產品或市場上，並識別表現不佳的領域以進行改進。銷售團隊可以利用此圖分析不同產品的銷售比重，進而調整銷售策略。同時，投資者也可藉由分析一家公司或某產業的營業額佔比構成，評估其業務組合的健康度、多元性及潛在風險，作為投資決策的重要參考依據。	{https://web02.mof.gov.tw/njswww/WebMain.aspx?sys=100&funid=defjspf2}	{doit}	2025-05-31 16:06:59.306469+00	2025-05-31 16:06:59.306469+00	two_d	\nWITH aggregated_revenues AS (\n    -- 計算臺北市的總營業額和全臺灣的總銷售額\n    SELECT\n        SUM("總計_營業額") AS total_taipei_revenue,\n        SUM("總計_全台銷售額") AS total_nationwide_revenue\n    FROM\n        business_tpe\n)\n-- 選出臺北市總營業額的百分比，並四捨五入到小數點後兩位\nSELECT\n    '臺北市總營業額' AS x_axis,\n    CASE\n        WHEN total_nationwide_revenue = 0 THEN 0 -- 避免除以零的錯誤\n        ELSE ROUND((total_taipei_revenue::NUMERIC * 100.0 / total_nationwide_revenue::NUMERIC), 2)\n    END AS data\nFROM\n    aggregated_revenues\nUNION ALL\n-- 計算並選出臺灣其他地區總營業額的百分比，並四捨五入到小數點後兩位\nSELECT\n    '臺灣其他地區總營業額' AS x_axis,\n    CASE\n        WHEN total_nationwide_revenue = 0 THEN 0 -- 避免除以零的錯誤\n        ELSE ROUND(((total_nationwide_revenue - total_taipei_revenue)::NUMERIC * 100.0 / total_nationwide_revenue::NUMERIC), 2)\n    END AS data\nFROM\n    aggregated_revenues\n	\N	taipei
lang_friendly	\N	\N	\N	static	\N	\N	\N	產業局商業處	顯示雙北多語言服務設施的分布與可近性。	此圖展示雙北公共場所多語言服務設施的地理分佈，例如：多語種標示牌、提供多語言服務的人員（如服務中心、醫療院所）、多語音導覽設備、或具備多語翻譯功能的自助服務機等。圖中將標示這些設施的具體位置，並可結合服務語言種類進行分析，評估其對不同語言背景人士的便利程度。此外，圖表也可包含設施的詳細資訊，如支援的語言清單、服務時間或是否提供手語服務等。透過這些數據，有助於評估城市或區域在建構國際化與包容性環境的進程，提供不同語言使用者便利的服務，並協助政府機關、觀光產業與企業規劃更完善的語言支援策略，提升城市對國際訪客與多元族群的吸引力。	此圖可用於協助雙北的國際旅客或不同語言背景的居民快速找到所需的多語言服務。例如，初次造訪的遊客可利用此圖搜尋提供英語、日語或其他語種服務的醫療院所或觀光服務中心。對於政府機關而言，此圖是評估城市國際化服務水準的重要依據。政府可根據圖中數據，識別多語言服務不足的區域或服務類型，進而規劃增設或改進現有設施，以提升城市對國際人才和觀光客的吸引力。同時，私人企業（特別是觀光、餐飲、零售業）也可參考此圖，了解目標客群的語言需求，並考慮提供相應的多語言服務，以擴大客戶群並提升服務品質。	{https://data.taipei/dataset/detail?id=d807396c-e41f-4005-be42-0160280783a1}	{doit,ntpc}	2025-05-31 15:51:38.490739+00	2025-05-31 15:51:38.490739+00	two_d	\nSELECT\n    x_axis,\n    SUM(data) AS data\nFROM (\n    SELECT\n        '英文友善' AS x_axis,\n        SUM(英文友善) AS data\n    FROM \n        public.friendly_info_tpe\n    UNION ALL\n    SELECT\n        '英文友善' AS x_axis,\n        SUM(英文友善) AS data\n    FROM\n        public.friendly_info_new_tpe\n) combined_data\nGROUP BY x_axis\n\nUNION ALL\n\nSELECT\n    x_axis,\n    SUM(data) AS data\nFROM (\n    SELECT\n        '日文友善' AS x_axis,\n        SUM(日文友善) AS data\n    FROM \n        public.friendly_info_tpe\n    UNION ALL\n    SELECT\n        '日文友善' AS x_axis,\n        SUM(日文友善) AS data\n    FROM\n        public.friendly_info_new_tpe\n) combined_data\nGROUP BY x_axis\n\nUNION ALL\n\nSELECT\n    x_axis,\n    SUM(data) AS data\nFROM (\n    SELECT\n        '韓文友善' AS x_axis,\n        SUM(韓文友善) AS data\n    FROM \n        public.friendly_info_tpe\n    UNION ALL\n    SELECT\n        '韓文友善' AS x_axis,\n        SUM(韓文友善) AS data\n    FROM\n        public.friendly_info_new_tpe\n) combined_data\nGROUP BY x_axis\n\nORDER BY x_axis\n\n	\N	metrotaipei
year_trend_tpe	\N	{}	\N	static	\N	\N	\N	主計處	\N	\N	\N	{}	{doit}	2025-05-31 13:30:39.306282+00	2025-05-31 13:30:39.306282+00	two_d	SELECT * FROM public.year_trend_tpe	\N	taipei
aed_taipei_trends	\N	{1}	\N	static	\N	\N	\N	Google Trends	\N	\N	\N	{https://data.taipei/dataset/detail?id=64c8a3a0-3b9a-4f49-a13a-fb1eb2ffa4b1}	{doit}	2025-05-31 13:40:36.743918+00	2025-05-31 13:40:36.743918+00	bar	SELECT 商圈 AS x_axis, '搜尋熱度' AS y_axis, 搜尋熱度 AS data FROM (SELECT * FROM top5_taipei_trends) d ORDER BY 搜尋熱度 DESC	\N	taipei
taipei_search_trends	\N	{1}	\N	static	\N	\N	\N	Google Trends	\N	\N	\N	{https://youtu.be/ULj4Pj-jmAc?si=LHUT496neaN1bgRV}	{doit}	2025-05-31 13:43:08.215569+00	2025-05-31 13:43:08.215569+00	three_d	SELECT x_axis, data FROM (SELECT '台北車站' AS x_axis, 84.56603773584905 AS data UNION ALL SELECT '大安路' AS x_axis, 82.79245283018868 AS data UNION ALL SELECT '永康街' AS x_axis, 82.16981132075472 AS data UNION ALL SELECT '東區' AS x_axis, 80.64150943396227 AS data UNION ALL SELECT '西門町' AS x_axis, 71.28301886792453 AS data) d ORDER BY data DESC	\N	taipei
business_shop_category	\N	\N	\N	static	\N	\N	\N	財政部	顯示臺北市各行政區商家數產業類別占比	此圖表呈現臺北市特定區域內（例如：行政區）不同產業類別的商家數量在總商家數中所佔的比例。圖中將各產業（例如：餐飲業、零售業、服務業、文創業、製造業等）的商家數量進行統計，並以圓餅圖、長條圖或堆疊長條圖等形式，直觀地顯示其百分比分佈。圖表可進一步結合時間軸，追蹤各產業商家數佔比的年度或季度變化趨勢，從而揭示特定產業的成長或衰退狀況。此外，也可細分至不同商圈或街區層級，以呈現更精細的商業結構。透過這些數據，有助於分析區域的商業生態、產業多元性、就業機會分佈，提供政府機關進行招商引資、產業輔導、都市規劃，以及企業進行市場評估與競爭分析的參考依據。	此圖可用於協助政府機關評估區域的產業結構與商業發展趨勢。例如，市政單位可透過此圖了解哪些產業在區域內佔主導地位，哪些新興產業正在崛起，進而制定有針對性的招商引資政策，或提供產業輔導資源。對於有意投資或創業的企業而言，此圖是評估目標市場競爭程度與商業機會的重要依據。例如，若某區域某產業的商家數佔比過高，可能表示競爭激烈；反之，則可能存在市場空白。同時，不動產開發商或仲介也可利用此圖分析不同區域的商業活力與潛力，作為商用不動產開發或租賃策略的參考。	{https://web02.mof.gov.tw/njswww/WebMain.aspx?sys=100&funid=defjspf2}	{doit}	2025-05-31 17:30:06.117505+00	2025-05-31 17:30:06.117505+00	two_d	\nWITH taipei_five_major_business_sum AS (\n    -- 計算臺北市五大民生產業的商家數總和，若無資料則為 0\n    SELECT\n        COALESCE(SUM("批發業_商家數"), 0) +\n        COALESCE(SUM("零售業_商家數"), 0) +\n        COALESCE(SUM("餐飲業_商家數"), 0) +\n        COALESCE(SUM("住宿業_商家數"), 0) +\n        COALESCE(SUM("藝術、娛樂及休閒服務業_商家數"), 0) AS total_five_major_count\n    FROM\n        business_tpe\n),\ntotal_taipei_business_all_industries AS (\n    -- 計算臺北市所有產業的總商家數，若無資料則為 0\n    SELECT\n        COALESCE(SUM("總計_商家數"), 0) AS total_count\n    FROM\n        business_tpe\n),\nother_industries_taipei_count AS (\n    -- 計算臺北市其他產業的總商家數\n    SELECT\n        GREATEST(0, -- 確保不會是負數\n            (SELECT total_count FROM total_taipei_business_all_industries) -\n            (SELECT total_five_major_count FROM taipei_five_major_business_sum)\n        ) AS count\n)\n-- 臺北市五大民生產業商家數總和佔其市總商家數的百分比\nSELECT\n    '臺北市五大產業商家數總和' AS x_axis,\n    CASE\n        WHEN (SELECT total_count FROM total_taipei_business_all_industries) = 0 THEN 0\n        ELSE ROUND(((SELECT total_five_major_count FROM taipei_five_major_business_sum)::NUMERIC * 100.0 / (SELECT total_count FROM total_taipei_business_all_industries)::NUMERIC), 2)\n    END AS data\nUNION ALL\n-- 臺北市其他產業商家數佔其市總商家數的百分比\nSELECT\n    '臺北市其他產業商家數' AS x_axis,\n    CASE\n        WHEN (SELECT total_count FROM total_taipei_business_all_industries) = 0 THEN 0\n        ELSE ROUND(((SELECT count FROM other_industries_taipei_count)::NUMERIC * 100.0 / (SELECT total_count FROM total_taipei_business_all_industries)::NUMERIC), 2)\n    END AS data;\n	\N	taipei
gender_friendly	\N	\N	\N	static	\N	\N	\N	產業局商業處	顯示臺北市生理友善空間的分布與服務普及情形	此圖呈現臺北市內具備生理友善設施的空間分布情況，特別針對『友善廁所』、『哺集乳友善』、『穆斯林友善』與『月經友善』四項關鍵服務進行分類統計。透過地圖視覺化與比例長條圖，使用者可了解各區域的友善空間密度與友善項目提供情況，並可依據需求篩選顯示特定服務類型。圖表亦可顯示各項目在全市店家中的普及率，有助於掌握目前資源分布的均衡程度，辨識仍需加強的區域與項目。此資訊對於政策制定、場域升級與服務優化具參考價值。	可用於評估臺北市在生理友善環境建置方面的整體進展，藉由此圖表分析各友善項目的空間分布與服務密度，辨識特定行政區內友善資源的豐富度與缺口，進而輔助推動針對性的政策，例如擴增哺集乳室設置、改善性別友善廁所覆蓋率等。透過結合地理資訊與分類統計，本組件有助於打造更具包容性與性別平權的城市環境，實踐社會友善、健康平權與多元文化尊重等核心價值。	{https://data.taipei/dataset/detail?id=d807396c-e41f-4005-be42-0160280783a1}	{doit}	2025-05-31 15:48:09.81836+00	2025-05-31 15:48:09.81836+00	three_d	\nSELECT\n    '無障礙友善' AS x_axis,\n\t'臺北' AS y_axis,\n    SUM(無障礙友善) AS data\nFROM\n\tpublic.friendly_info_tpe\n\nUNION ALL\n\nSELECT\n    '性別友善' AS x_axis,\n\t'臺北' AS y_axis,\n    SUM(性別友善) AS data\nFROM\n\tpublic.friendly_info_tpe\n\nUNION ALL\n\nSELECT\n    '友善廁所' AS x_axis,\n\t'臺北' AS y_axis,\n    SUM(友善廁所) AS data\nFROM\n\tpublic.friendly_info_tpe\n\t\nUNION ALL\n\nSELECT\n    '哺集乳友善' AS x_axis,\n\t'臺北' AS y_axis,\n    SUM(哺集乳友善) AS data\nFROM\n\tpublic.friendly_info_tpe\n\nUNION ALL\n\nSELECT\n    '月經友善' AS x_axis,\n\t'臺北' AS y_axis,\n    SUM(月經友善) AS data\nFROM\n\tpublic.friendly_info_tpe\n\nORDER BY x_axis, y_axis\n	\N	taipei
business_category	\N	\N	\N	static	\N	\N	\N	財政部	顯示新北市不同產業類別的營業額佔總營業額的比例	此圖表展示雙北各產業類別在總營業額中的佔比，透過圓餅圖或長條圖呈現不同產業（例如：製造業、服務業、批發零售業、金融業等）的營業額數據，並分析其對整體經濟的貢獻度。圖表將可結合時間軸，顯示各產業類別營業額佔比的年度或季度變化趨勢，並可進一步細分至不同區域或城市層級。透過這些數據，可評估各產業的發展狀況、經濟結構的多元性，並有助於政府制定產業政策、引導投資方向，以及企業了解市場競爭格局與潛在機會。	此圖可用於新北市分析產業結構的現況與趨勢。政府機關可利用此圖評估不同產業對經濟成長的貢獻，進而制定有針對性的產業扶植政策或資源分配策略。例如，當發現特定產業佔比過高時，可評估是否存在產業過度集中的風險，並考慮推動產業多元化。對於企業而言，此圖有助於了解市場的產業分佈與競爭態勢，例如在進入新市場前，可藉由分析不同產業的營業額佔比，評估該市場的產業潛力與競爭激烈程度，作為投資決策的重要參考。此外，投資者可透過此圖分析各產業的發展前景，進而調整投資組合，達到風險分散與收益最大化的目標。	{https://web02.mof.gov.tw/njswww/WebMain.aspx?sys=100&funid=defjspf2,https://web02.mof.gov.tw/njswww/WebMain.aspx?sys=100&funid=defjspf2}	{doit,ntpc}	2025-05-31 16:50:51.358376+00	2025-05-31 16:50:51.358376+00	two_d	\nWITH taipei_five_major_sum AS (\n    -- 計算臺北市五大民生產業的總營業額，若無資料則為 0\n    SELECT\n        COALESCE(SUM("批發業_營業額"), 0) +\n        COALESCE(SUM("零售業_營業額"), 0) +\n        COALESCE(SUM("餐飲業_營業額"), 0) +\n        COALESCE(SUM("住宿業_營業額"), 0) +\n        COALESCE(SUM("藝術、娛樂及休閒服務業_營業額"), 0) AS total_revenue\n    FROM\n        business_tpe\n),\nnew_taipei_five_major_sum AS (\n    -- 計算新北市五大民生產業的總營業額，若無資料則為 0\n    SELECT\n        COALESCE(SUM("批發業_營業額"), 0) +\n        COALESCE(SUM("零售業_營業額"), 0) +\n        COALESCE(SUM("餐飲業_營業額"), 0) +\n        COALESCE(SUM("住宿業_營業額"), 0) +\n        COALESCE(SUM("藝術、娛樂及休閒服務業_營業額"), 0) AS total_revenue\n    FROM\n        business_new_tpe\n),\ntaipei_total_revenue_all_industries AS (\n    -- 計算臺北市所有產業的總營業額，若無資料則為 0\n    SELECT\n        COALESCE(SUM("總計_營業額"), 0) AS total_revenue\n    FROM\n        business_tpe\n),\nnew_taipei_total_revenue_all_industries AS (\n    -- 計算新北市所有產業的總營業額，若無資料則為 0\n    SELECT\n        COALESCE(SUM("總計_營業額"), 0) AS total_revenue\n    FROM\n        business_new_tpe\n),\ntaipei_other_industries_revenue AS (\n    -- 計算臺北市其他產業的總營業額\n    SELECT\n        GREATEST(0, -- 確保不會是負數\n            (SELECT total_revenue FROM taipei_total_revenue_all_industries) -\n            (SELECT total_revenue FROM taipei_five_major_sum)\n        ) AS revenue\n),\nnew_taipei_other_industries_revenue AS (\n    -- 計算新北市其他產業的總營業額\n    SELECT\n        GREATEST(0, -- 確保不會是負數\n            (SELECT total_revenue FROM new_taipei_total_revenue_all_industries) -\n            (SELECT total_revenue FROM new_taipei_five_major_sum)\n        ) AS revenue\n)\n-- 臺北市五大民生產業佔其市總營業額的百分比\nSELECT\n    '臺北市五大產業佔比' AS x_axis,\n    CASE\n        WHEN (SELECT total_revenue FROM taipei_total_revenue_all_industries) = 0 THEN 0\n        ELSE ROUND(((SELECT total_revenue FROM taipei_five_major_sum)::NUMERIC * 100.0 / (SELECT total_revenue FROM taipei_total_revenue_all_industries)::NUMERIC), 2)\n    END AS data\nUNION ALL\n-- 新北市五大民生產業佔其市總營業額的百分比\nSELECT\n    '新北市五大產業佔比' AS x_axis,\n    CASE\n        WHEN (SELECT total_revenue FROM new_taipei_total_revenue_all_industries) = 0 THEN 0\n        ELSE ROUND(((SELECT total_revenue FROM new_taipei_five_major_sum)::NUMERIC * 100.0 / (SELECT total_revenue FROM new_taipei_total_revenue_all_industries)::NUMERIC), 2)\n    END AS data\nUNION ALL\n-- 臺北市其他產業佔其市總營業額的百分比\nSELECT\n    '臺北市其他產業佔比' AS x_axis,\n    CASE\n        WHEN (SELECT total_revenue FROM taipei_total_revenue_all_industries) = 0 THEN 0\n        ELSE ROUND(((SELECT revenue FROM taipei_other_industries_revenue)::NUMERIC * 100.0 / (SELECT total_revenue FROM taipei_total_revenue_all_industries)::NUMERIC), 2)\n    END AS data\nUNION ALL\n-- 新北市其他產業佔其市總營業額的百分比\nSELECT\n    '新北市其他產業佔比' AS x_axis,\n    CASE\n        WHEN (SELECT total_revenue FROM new_taipei_total_revenue_all_industries) = 0 THEN 0\n        ELSE ROUND(((SELECT revenue FROM new_taipei_other_industries_revenue)::NUMERIC * 100.0 / (SELECT total_revenue FROM new_taipei_total_revenue_all_industries)::NUMERIC), 2)\n    END AS data;\n	\N	metrotaipei
electric_charging_station	\N	{7}	\N	static	\N	0	\N	環保局	顯示雙北市電動汽機車換電站的分布情形與服務量能	此圖呈現雙北市範圍內電動汽機車換電站的地理分布與服務項目狀態，涵蓋多家業者與不同型態的換電站（如速換、快充、複合式服務站等）。使用互動式地圖與分類統計圖表，視覺化展示各行政區換電站的密度、可用站點數量與成長趨勢，並標示重點換電熱區及其支援車型範圍。圖表中亦可區分機車與汽車換電站服務類型，有助於瞭解目前綠色交通基礎建設的覆蓋情形與發展現況。此資訊對推動電動車普及與永續交通政策具有重要參考價值。	可用於評估雙北市電動車基礎建設的布局與效能，透過本圖表分析各區換電站密度、站點成長速率與空白區域，進而輔助政府及企業針對性增設設施。同時可依據車型分類（如機車與汽車）進行資源優化規劃，支援民眾查找最近換電據點，並提供政策單位規劃補助路線或設站優先順序參考。亦有助於企業評估合作點位選址，強化電動車使用體驗並推進雙北朝向淨零運輸目標邁進。	{https://data.ntpc.gov.tw/datasets/1bb694e3-17c7-4ef0-ac75-52990c40edcd,https://data.ntpc.gov.tw/datasets/e461bc62-34d2-42c5-a871-f2fc2fb88d01}	{doit,ntpc}	2025-05-31 05:13:19.539277+00	2025-05-31 05:13:19.539277+00	two_d	\nSELECT 行政區 AS x_axis, SUM(total_count) AS data\nFROM (\n    SELECT 行政區, COUNT(*) AS total_count\n    FROM public.electric_charging_station_tpe\n    GROUP BY 行政區\n    UNION ALL\n    SELECT 行政區, COUNT(*) AS total_count\n    FROM public.electric_charging_station_new_tpe\n    GROUP BY 行政區\n) AS combined_table\nGROUP BY 行政區\nORDER BY ARRAY_POSITION(ARRAY['北投區', '士林區', '內湖區', '中山區', '松山區', '信義區', '中正區', '大安區', '萬華區', '文山區', '新莊區', '淡水區', '汐止區', '板橋區', '三重區', '樹林區', '土城區', '鶯歌區', '中和區', '永和區', '新店區', '三峽區', '瑞芳區', '五股區', '泰山區', '林口區', '深坑區', '石碇區', '坪林區', '三芝區', '石門區', '八里區', '平溪區', '雙溪區', '貢寮區', '金山區', '萬里區', '烏來區'], 行政區)\n	\N	metrotaipei
business_shop_count	\N	\N	\N	static	\N	0	\N	財政部	顯示雙北不同分類或項目在總商家數中的比例	此圖表呈現雙北特定範圍內（例如：單一區域、某產業、某類別）不同分類或項目在總商家數中所佔的比例。透過這些數據，有助於政府機關進行都市發展、商業規劃、政策制定，以及企業進行市場評估、選址決策、競爭分析。	此圖可用於協助政府機關進行城市或區域的商業結構分析。例如，市政單位可透過此圖了解不同區域的商業發展均衡性，或是特定商業區的店家類型分佈，進而規劃相應的輔導政策或基礎設施建設。對於有意投資或拓展業務的企業而言，此圖是評估目標市場商業環境與競爭態勢的重要依據。例如，新品牌可藉由分析不同區域的商家數佔比，找出競爭相對較小或市場需求尚未飽和的潛力區。同時，不動產開發商或仲介也可利用此圖分析各街區的商業活力與潛力，作為商用不動產投資或招租策略的參考。	{https://web02.mof.gov.tw/njswww/WebMain.aspx?sys=100&funid=defjspf2,https://web02.mof.gov.tw/njswww/WebMain.aspx?sys=100&funid=defjspf2}	{doit,ntpc}	2025-05-31 17:28:08.584054+00	2025-05-31 17:28:08.584054+00	two_d	\nWITH taipei_total_business_count AS (\n    -- 計算臺北市的總商家數，若無資料則為 0\n    SELECT\n        COALESCE(SUM("總計_商家數"), 0) AS count\n    FROM\n        business_tpe\n),\nnew_taipei_total_business_count AS (\n    -- 計算新北市的總商家數，若無資料則為 0\n    SELECT\n        COALESCE(SUM("總計_商家數"), 0) AS count\n    FROM\n        business_new_tpe\n),\nnationwide_total_business_count AS (\n    -- 計算全臺灣的總商家數，若無資料則為 0\n    SELECT\n        COALESCE(SUM("總計_全台商家數"), 0) AS count\n    FROM\n        business_tpe \n),\nrest_of_taiwan_business_count AS (\n    -- 計算臺灣其他地區的總商家數\n    SELECT\n        GREATEST(0,\n            (SELECT count FROM nationwide_total_business_count) -\n            (SELECT count FROM taipei_total_business_count) -\n            (SELECT count FROM new_taipei_total_business_count)\n        ) AS count\n)\n-- 臺北市總商家數佔全臺灣總商家數的百分比\nSELECT\n    '臺北市商家數佔比' AS x_axis,\n    CASE\n        WHEN (SELECT count FROM nationwide_total_business_count) = 0 THEN 0\n        ELSE ROUND(((SELECT count FROM taipei_total_business_count)::NUMERIC * 100.0 / (SELECT count FROM nationwide_total_business_count)::NUMERIC), 2)\n    END AS data\nUNION ALL\n-- 新北市總商家數佔全臺灣總商家數的百分比\nSELECT\n    '新北市商家數佔比' AS x_axis,\n    CASE\n        WHEN (SELECT count FROM nationwide_total_business_count) = 0 THEN 0\n        ELSE ROUND(((SELECT count FROM new_taipei_total_business_count)::NUMERIC * 100.0 / (SELECT count FROM nationwide_total_business_count)::NUMERIC), 2)\n    END AS data\nUNION ALL\n-- 臺灣其他地區總商家數佔全臺灣總商家數的百分比\nSELECT\n    '臺灣其他地區商家數佔比' AS x_axis,\n    CASE\n        WHEN (SELECT count FROM nationwide_total_business_count) = 0 THEN 0\n        ELSE ROUND(((SELECT count FROM rest_of_taiwan_business_count)::NUMERIC * 100.0 / (SELECT count FROM nationwide_total_business_count)::NUMERIC), 2)\n    END AS data;\n	\N	metrotaipei
year_trend_market	null	{}	null	static	\N	\N	\N	Google Trends	顯示雙北各商圈在網路上的搜尋聲量與熱門程度。	此圖表呈現雙北各主要商圈在網路上的搜尋熱度，透過分析社群媒體、搜尋引擎（如Google Trends）的關鍵字搜尋量、線上評論數、導航地圖的路線規劃頻率等數據，量化各商圈的線上關注度與人氣。圖中可運用熱力圖或顏色深淺標示不同商圈的熱度級別，並可結合時間軸，顯示各商圈在不同時段（例如：假日/平日、特定節慶活動期間）的搜尋熱度變化趨勢。此外，圖表也可進一步分析與特定主題（例如：美食、購物、文化活動）相關的搜尋熱度，以描繪商圈的特色與吸引力。透過這些數據，有助於評估商圈的當前知名度與潛力，提供企業進行行銷策略規劃、選址評估，以及政府機關在商圈活化、觀光推廣上的決策參考。	此圖可用於協助企業評估雙北商圈的潛在客流量與市場吸引力，作為開店選址或行銷推廣的重要依據。例如，新興品牌可透過此圖找出搜尋熱度高且符合其品牌定位的商圈進行拓點。對於觀光業者或活動策劃者而言，此圖可協助他們掌握當前最受歡迎的商圈，進而規劃旅遊行程或舉辦相關活動，以吸引更多人潮。同時，政府單位也可利用此數據評估商圈的活絡程度，識別需要更多資源投入或行銷推廣的商圈，進而制定商圈振興計畫，提升區域經濟發展。此外，投資者也可將商圈搜尋熱度作為評估不動產投資價值的參考指標之一。	{}	{doit,ntpc}	2025-05-31 14:02:18.723585+00	2025-05-31 14:07:15.163613+00	two_d	SELECT 商圈 AS x_axis, 搜尋熱度 AS data FROM public.year_trend_metro	\N	metrotaipei
toilet_info	\N	{3}	\N	static	\N	0	\N	環保局	顯示臺北市友善廁所與一般公廁的分布情形與服務覆蓋率	此圖表展示臺北市內公廁設施的空間分布與友善程度，主要區分為『一般公廁』與『友善廁所』（具備無障礙空間、性別友善設計、哺乳室等設施）。透過地圖可視化與分類統計圖，可分析各行政區友善廁所的密度與佔比，同時標示資源集中與不足區域。圖表亦可呈現友善廁所在整體廁所中的占比，協助理解臺北在無障礙與性別友善公共設施方面的建設進展。該資料有助於促進公共空間普及友善設施、提升市民如廁體驗與使用安全。	可用於評估臺北市在推動友善廁所普及政策的成效，透過地圖與統計圖分析各區友善公廁與一般公廁的分布差異。政府單位可根據此資料辨識設施密度不均、資源不足區域，作為後續設站與改善依據；民間開發者亦可整合進行如廁點查詢應用，提升民眾對友善空間的使用率與感受。此分析亦有助於監測性別友善與無障礙空間的城市進展，推動公共設施朝向普及與平權發展。	{}	{doit}	2025-05-31 02:34:27.58766+00	2025-05-31 02:34:27.58766+00	three_d	\nSELECT \n    行政區 AS x_axis,\n    廁所類型 AS y_axis,\n    COUNT(*) AS data\nFROM \n    public.toilet_tpe\nGROUP BY \n    x_axis, y_axis\nORDER BY ARRAY_POSITION(ARRAY['北投區', '士林區', '內湖區', '南港區', '松山區', '信義區', '中山區', '大同區'], 行政區)\n	\N	taipei
business_category	\N	\N	\N	static	\N	0	\N	財政部	顯示臺北市不同產業類別的營業額佔總營業額的比例	此圖表展示臺北市各產業類別在總營業額中的佔比，透過圓餅圖或長條圖呈現不同產業（例如：製造業、服務業、批發零售業、金融業等）的營業額數據，並分析其對整體經濟的貢獻度。圖表將可結合時間軸，顯示各產業類別營業額佔比的年度或季度變化趨勢，並可進一步細分至不同區域或城市層級。透過這些數據，可評估各產業的發展狀況、經濟結構的多元性，並有助於政府制定產業政策、引導投資方向，以及企業了解市場競爭格局與潛在機會。	此圖可用於分析臺北市產業結構的現況與趨勢。政府機關可利用此圖評估不同產業對經濟成長的貢獻，進而制定有針對性的產業扶植政策或資源分配策略。例如，當發現特定產業佔比過高時，可評估是否存在產業過度集中的風險，並考慮推動產業多元化。對於企業而言，此圖有助於了解市場的產業分佈與競爭態勢，例如在進入新市場前，可藉由分析不同產業的營業額佔比，評估該市場的產業潛力與競爭激烈程度，作為投資決策的重要參考。此外，投資者可透過此圖分析各產業的發展前景，進而調整投資組合，達到風險分散與收益最大化的目標。	{https://web02.mof.gov.tw/njswww/WebMain.aspx?sys=100&funid=defjspf2}	{doit}	2025-05-31 16:50:51.358376+00	2025-05-31 16:50:51.358376+00	two_d	\nWITH five_major_industries_sum AS (\n    -- 計算臺北市五大民生產業的總營業額，若無資料則為 0\n    SELECT\n        COALESCE(SUM("批發業_營業額"), 0) +\n        COALESCE(SUM("零售業_營業額"), 0) +\n        COALESCE(SUM("餐飲業_營業額"), 0) +\n        COALESCE(SUM("住宿業_營業額"), 0) +\n        COALESCE(SUM("藝術、娛樂及休閒服務業_營業額"), 0) AS total_five_major_revenue\n    FROM\n        business_tpe\n),\ntotal_taipei_revenue_all_industries AS (\n    -- 計算臺北市所有產業的總營業額，若無資料則為 0\n    SELECT\n        COALESCE(SUM("總計_營業額"), 0) AS total_revenue\n    FROM\n        business_tpe\n),\nother_industries_revenue AS (\n    -- 計算臺北市其他產業的總營業額\n    SELECT\n        GREATEST(0, -- 確保不會是負數\n            (SELECT total_revenue FROM total_taipei_revenue_all_industries) -\n            (SELECT total_five_major_revenue FROM five_major_industries_sum)\n        ) AS revenue\n)\n-- 五大民生產業總和營業額佔臺北市所有產業總營業額的百分比\nSELECT\n    '五大產業(批發、零售、飲食、住宿、藝文)總和' AS x_axis,\n    CASE\n        WHEN (SELECT total_revenue FROM total_taipei_revenue_all_industries) = 0 THEN 0\n        ELSE ROUND(((SELECT total_five_major_revenue FROM five_major_industries_sum)::NUMERIC * 100.0 / (SELECT total_revenue FROM total_taipei_revenue_all_industries)::NUMERIC), 2)\n    END AS data\nUNION ALL\n-- 臺北市其他產業營業額佔臺北市所有產業總營業額的百分比\nSELECT\n    '臺北市其他產業' AS x_axis,\n    CASE\n        WHEN (SELECT total_revenue FROM total_taipei_revenue_all_industries) = 0 THEN 0\n        ELSE ROUND(((SELECT revenue FROM other_industries_revenue)::NUMERIC * 100.0 / (SELECT total_revenue FROM total_taipei_revenue_all_industries)::NUMERIC), 2)\n    END AS data\n	\N	taipei
business_shop_category	\N	\N	\N	static	\N	0	\N	財政部	顯示雙北各行政區商家數產業類別占比	此圖表呈現雙北特定區域內（例如：行政區）不同產業類別的商家數量在總商家數中所佔的比例。圖中將各產業（例如：餐飲業、零售業、服務業、文創業、製造業等）的商家數量進行統計，並以圓餅圖、長條圖或堆疊長條圖等形式，直觀地顯示其百分比分佈。圖表可進一步結合時間軸，追蹤各產業商家數佔比的年度或季度變化趨勢，從而揭示特定產業的成長或衰退狀況。此外，也可細分至不同商圈或街區層級，以呈現更精細的商業結構。透過這些數據，有助於分析區域的商業生態、產業多元性、就業機會分佈，提供政府機關進行招商引資、產業輔導、都市規劃，以及企業進行市場評估與競爭分析的參考依據。	此圖可用於協助政府機關評估區域的產業結構與商業發展趨勢。例如，市政單位可透過此圖了解哪些產業在區域內佔主導地位，哪些新興產業正在崛起，進而制定有針對性的招商引資政策，或提供產業輔導資源。對於有意投資或創業的企業而言，此圖是評估目標市場競爭程度與商業機會的重要依據。例如，若某區域某產業的商家數佔比過高，可能表示競爭激烈；反之，則可能存在市場空白。同時，不動產開發商或仲介也可利用此圖分析不同區域的商業活力與潛力，作為商用不動產開發或租賃策略的參考。	{https://web02.mof.gov.tw/njswww/WebMain.aspx?sys=100&funid=defjspf2,https://web02.mof.gov.tw/njswww/WebMain.aspx?sys=100&funid=defjspf2}	{doit,ntpc}	2025-05-31 17:30:06.158418+00	2025-05-31 17:30:06.158418+00	two_d	\nWITH taipei_five_major_count_sum AS (\n    -- 計算臺北市五大民生產業的商家數總和，若無資料則為 0\n    SELECT\n        COALESCE(SUM("批發業_商家數"), 0) +\n        COALESCE(SUM("零售業_商家數"), 0) +\n        COALESCE(SUM("餐飲業_商家數"), 0) +\n        COALESCE(SUM("住宿業_商家數"), 0) +\n        COALESCE(SUM("藝術、娛樂及休閒服務業_商家數"), 0) AS total_count\n    FROM\n        business_tpe\n),\nnew_taipei_five_major_count_sum AS (\n    -- 計算新北市五大民生產業的商家數總和，若無資料則為 0\n    SELECT\n        COALESCE(SUM("批發業_商家數"), 0) +\n        COALESCE(SUM("零售業_商家數"), 0) +\n        COALESCE(SUM("餐飲業_商家數"), 0) +\n        COALESCE(SUM("住宿業_商家數"), 0) +\n        COALESCE(SUM("藝術、娛樂及休閒服務業_商家數"), 0) AS total_count\n    FROM\n        business_new_tpe\n),\ntaipei_total_count_all_industries AS (\n    -- 計算臺北市所有產業的總商家數，若無資料則為 0\n    SELECT\n        COALESCE(SUM("總計_商家數"), 0) AS total_count\n    FROM\n        business_tpe\n),\nnew_taipei_total_count_all_industries AS (\n    -- 計算新北市所有產業的總商家數，若無資料則為 0\n    SELECT\n        COALESCE(SUM("總計_商家數"), 0) AS total_count\n    FROM\n        business_new_tpe\n),\ntaipei_other_industries_count AS (\n    -- 計算臺北市其他產業的商家數\n    SELECT\n        GREATEST(0, -- 確保不會是負數\n            (SELECT total_count FROM taipei_total_count_all_industries) -\n            (SELECT total_count FROM taipei_five_major_count_sum)\n        ) AS count\n),\nnew_taipei_other_industries_count AS (\n    -- 計算新北市其他產業的商家數\n    SELECT\n        GREATEST(0, -- 確保不會是負數\n            (SELECT total_count FROM new_taipei_total_count_all_industries) -\n            (SELECT total_count FROM new_taipei_five_major_count_sum)\n        ) AS count\n)\n-- 臺北市五大民生產業商家數佔其市總商家數的百分比\nSELECT\n    '臺北市五大產業商家數佔比' AS x_axis,\n    CASE\n        WHEN (SELECT total_count FROM taipei_total_count_all_industries) = 0 THEN 0\n        ELSE ROUND(((SELECT total_count FROM taipei_five_major_count_sum)::NUMERIC * 100.0 / (SELECT total_count FROM taipei_total_count_all_industries)::NUMERIC), 2)\n    END AS data\nUNION ALL\n-- 新北市五大民生產業商家數佔其市總商家數的百分比\nSELECT\n    '新北市五大產業商家數佔比' AS x_axis,\n    CASE\n        WHEN (SELECT total_count FROM new_taipei_total_count_all_industries) = 0 THEN 0\n        ELSE ROUND(((SELECT total_count FROM new_taipei_five_major_count_sum)::NUMERIC * 100.0 / (SELECT total_count FROM new_taipei_total_count_all_industries)::NUMERIC), 2)\n    END AS data\nUNION ALL\n-- 臺北市其他產業商家數佔其市總商家數的百分比\nSELECT\n    '臺北市其他產業商家數佔比' AS x_axis,\n    CASE\n        WHEN (SELECT total_count FROM taipei_total_count_all_industries) = 0 THEN 0\n        ELSE ROUND(((SELECT count FROM taipei_other_industries_count)::NUMERIC * 100.0 / (SELECT total_count FROM taipei_total_count_all_industries)::NUMERIC), 2)\n    END AS data\nUNION ALL\n-- 新北市其他產業商家數佔其市總商家數的百分比\nSELECT\n    '新北市其他產業商家數佔比' AS x_axis,\n    CASE\n        WHEN (SELECT total_count FROM new_taipei_total_count_all_industries) = 0 THEN 0\n        ELSE ROUND(((SELECT count FROM new_taipei_other_industries_count)::NUMERIC * 100.0 / (SELECT total_count FROM new_taipei_total_count_all_industries)::NUMERIC), 2)\n    END AS data;\n	\N	metrotaipei
\.
...
SELECT pg_catalog.setval('public.component_maps_id_seq', 9, true);
...
SELECT pg_catalog.setval('public.components_id_seq', 22, true);
...
SELECT pg_catalog.setval('public.dashboards_id_seq', 386, true);
