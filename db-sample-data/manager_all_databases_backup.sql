...
1	user	salami@gmail.com	283aea2d8f9d63c02e165b7869cd7ebe2262d15ef31ea81714a39ab54ee1a42f	\N	\N	\N	\N	\N	t	t	t	f	\N	2025-05-29 13:00:09.883753+00	2025-05-31 05:53:29.470737+00
\.
...
electric_charging_station	{#a0b8e8,#b7ff98,#4369db}	{DistrictChart,ColumnChart}	個
...
7	electric_charging_station_metrotaipei	電動機車充電站	circle	geojson	\N	\N	{\n  "circle-color": [\n    "match",\n    ["get", "行政區"],\n    "北投區", "#2894FF",\n    "士林區", "#33A1FF",\n    "內湖區", "#4DAAFF",\n    "南港區", "#66B3FF",\n    "松山區", "#7FBFFF",\n    "信義區", "#99CCFF",\n    "中山區", "#B2D8FF",\n    "大同區", "#CCE5FF",\n    "中正區", "#E5F2FF",\n    "萬華區", "#00EC00",\n    "大安區", "#00D900",\n    "文山區", "#00C600",\n    "新莊區", "#FF5733",\n    "淡水區", "#FFC300",\n    "汐止區", "#DAF7A6",\n    "板橋區", "#FF33FF",\n    "三重區", "#C70039",\n    "樹林區", "#900C3F",\n    "土城區", "#581845",\n    "蘆洲區", "#FF5733",\n    "中和區", "#FFC300",\n    "永和區", "#DAF7A6",\n    "新店區", "#FF33FF",\n    "鶯歌區", "#C70039",\n    "三峽區", "#900C3F",\n    "瑞芳區", "#581845",\n    "五股區", "#FF5733",\n    "泰山區", "#FFC300",\n    "林口區", "#DAF7A6",\n    "深坑區", "#FF33FF",\n    "石碇區", "#C70039",\n    "坪林區", "#900C3F",\n    "三芝區", "#581845",\n    "石門區", "#FF5733",\n    "八里區", "#FFC300",\n    "平溪區", "#DAF7A6",\n    "雙溪區", "#FF33FF",\n    "貢寮區", "#C70039",\n    "金山區", "#900C3F",\n    "萬里區", "#581845",\n    "烏來區", "#FF5733",\n    "#CCCCCC"]\n}\n	[\n  {\n    "key": "地址",\n    "name": "地址"\n  },\n  {\n    "key": "行政區",\n    "name": "行政區"\n  },\n  {\n    "key": "行政區代碼",\n    "name": "行政區代碼"\n  }\n]
...
toilet_info	\N	{4}	\N	static	\N	\N	\N	主計處	\N	\N	\N	{}	{doit,ntpc}	2025-05-30 15:08:44.858284+00	2025-05-30 15:08:44.858284+00	three_d	\nSELECT \n    行政區 as x_axis,\n    CASE \n        WHEN 友善廁所 = 1 THEN '友善廁所'\n        WHEN 友善廁所 = 0 THEN '一般公廁'\n    END AS y_axis,\n    COUNT(*) AS data\nFROM (\n    SELECT 行政區, 友善廁所 FROM public.toilet_tpe\n    UNION ALL\n    SELECT 行政區, 友善廁所 FROM public.toilet_new_tpe\n) AS combined_tables\nGROUP BY \n    x_axis, y_axis\nORDER BY\n\tx_axis, y_axis\n	\N	metrotaipei
